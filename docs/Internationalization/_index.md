...
<svg viewBox="0 0 820 480" width="820" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="235" y="40" class="b">Model display text</text>
  <text x="235" y="58" class="dim">title, subtitle, slot labels</text>
  <line class="flow" x1="410" y1="72" x2="410" y2="110" marker-end="url(#ai18n)"/>
  ...
  <line class="flow" x1="410" y1="180" x2="410" y2="220" marker-end="url(#ai18n)"/>
  <rect class="fill" x="220" y="220" width="380" height="70"/>
  ...
  <line class="flow" x1="410" y1="290" x2="410" y2="335" marker-end="url(#ai18n)"/>
  <text x="425" y="322" class="dim">cache miss</text>
  <rect class="fill" x="220" y="335" width="380" height="70"/>
