...
<svg viewBox="0 0 820 690" width="820" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect class="fill" x="55" y="70" width="345" height="65"/>
  <text x="227" y="95" text-anchor="middle" class="b">Browser loads boot loader</text>
  <text x="227" y="115" text-anchor="middle" class="dim">single script tag entry point</text>
  <rect class="fill" x="420" y="70" width="345" height="65"/>
  <text x="592" y="95" text-anchor="middle" class="b">Core boot files</text>
  <text x="592" y="115" text-anchor="middle" class="dim">Object, Promise, IndexedDB, HashCache, ResourceManager</text>
  ...
  <text x="410" y="255" text-anchor="middle" class="dim">Load _index.json: resource metadata + content hashes</text>
  <rect class="fill" x="55" y="273" width="710" height="30"/>
  <text x="410" y="293" text-anchor="middle" class="dim">Check HashCache: skip downloads for unchanged content</text>
  <rect class="fill" x="55" y="311" width="710" height="30"/>
  <text x="410" y="331" text-anchor="middle" class="dim">Download _cam.json.zip (compressed bundle) on cache miss</text>
  <rect class="fill" x="55" y="349" width="710" height="30"/>
  <text x="410" y="369" text-anchor="middle" class="dim">Evaluate CSS sequentially, then JS in dependency order; filter env-inappropriate files</text>
  ...
  <text x="410" y="499" text-anchor="middle" class="dim">Open persistent store; load root object from store</text>
  <rect class="fill" x="55" y="517" width="710" height="30"/>
  <text x="410" y="537" text-anchor="middle" class="dim">Pause schedulers; setupModel(); setupUi()</text>
  <rect class="fill" x="55" y="555" width="710" height="30"/>
  <text x="410" y="575" text-anchor="middle" class="dim">appDidInit fires: post notification, unhide root view, handle URL params</text>
  <rect class="fill" x="55" y="593" width="710" height="30"/>
  <text x="410" y="613" text-anchor="middle" class="dim">Resume schedulers</text>
