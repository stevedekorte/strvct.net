...
This document is intended to be read after [Naked Objects](../Naked%20Objects/) and the [Technical Overview](../Technical%20Overview/), which cover the design philosophy and high-level architecture of the Strvct framework. Here we go into the technical details of the implementation and how the various parts work together.
...
<svg viewBox="0 0 820 480" width="820" xmlns="http://www.w3.org/2000/svg">
  ...
  <line class="flow" x1="690" y1="125" x2="690" y2="155" marker-end="url(#aio)"/>
  <rect class="box" x="30" y="155" width="200" height="240"/>
  <text x="45" y="177" class="b">UI layer</text>
  <text x="45" y="197" class="dim">SvUserInterface root</text>
  <rect class="fill" x="45" y="220" width="170" height="160"/>
  <text x="130" y="260" text-anchor="middle" class="b">SvNodeView tree</text>
  <text x="130" y="282" text-anchor="middle" class="dim">each view holds one node;</text>
  <text x="130" y="300" text-anchor="middle" class="dim">multiple views may share</text>
  <text x="130" y="318" text-anchor="middle" class="dim">a node; observes its slots;</text>
  <text x="130" y="340" text-anchor="middle" class="dim">created lazily on navigation</text>
  <rect class="box" x="310" y="155" width="200" height="240"/>
  <text x="325" y="177" class="b">Model layer</text>
  <text x="325" y="197" class="dim">SvModel : SvStorableNode</text>
  <rect class="fill" x="325" y="220" width="170" height="160"/>
  <text x="410" y="260" text-anchor="middle" class="b">Domain SvNode graph</text>
  <text x="410" y="282" text-anchor="middle" class="dim">root of persistent state;</text>
  <text x="410" y="300" text-anchor="middle" class="dim">all data shapes are slots</text>
  <text x="410" y="318" text-anchor="middle" class="dim">on subclasses of SvNode;</text>
  <text x="410" y="340" text-anchor="middle" class="dim">no UI dependencies</text>
  <rect class="box" x="590" y="155" width="200" height="240"/>
  <text x="605" y="177" class="b">Storage layer</text>
  <text x="605" y="197" class="dim">SvPersistentObjectPool</text>
  <rect class="fill" x="605" y="220" width="170" height="160"/>
  <text x="690" y="260" text-anchor="middle" class="b">IndexedDB pool</text>
  <text x="690" y="282" text-anchor="middle" class="dim">observes mutations via</text>
  <text x="690" y="300" text-anchor="middle" class="dim">notifications; batches</text>
  <text x="690" y="318" text-anchor="middle" class="dim">end-of-loop commits;</text>
  <text x="690" y="340" text-anchor="middle" class="dim">handles GC on load</text>
  <line class="flow-dashed" x1="310" y1="280" x2="230" y2="280" marker-end="url(#aio)"/>
  <line class="flow" x1="230" y1="320" x2="310" y2="320" marker-end="url(#aio)"/>
  <text x="270" y="258" text-anchor="middle" class="dim">mutation</text>
  <text x="270" y="273" text-anchor="middle" class="dim">notification</text>
  <text x="270" y="333" text-anchor="middle" class="dim">getter, setter,</text>
  <text x="270" y="348" text-anchor="middle" class="dim">&amp; action calls</text>
  <line class="flow-dashed" x1="510" y1="280" x2="590" y2="280" marker-end="url(#aio)"/>
  <line class="flow" x1="590" y1="320" x2="510" y2="320" marker-end="url(#aio)"/>
  <text x="550" y="258" text-anchor="middle" class="dim">mutation</text>
  <text x="550" y="273" text-anchor="middle" class="dim">notification</text>
  <text x="550" y="333" text-anchor="middle" class="dim">loads &amp;</text>
  <text x="550" y="348" text-anchor="middle" class="dim">stores</text>
  <text x="410" y="420" text-anchor="middle" class="dim">Model is the source of truth.</text>
  <text x="410" y="440" text-anchor="middle" class="dim">Views and the storage system may hold references to the model, but the model holds none in return; it only posts notifications that they listen for.</text>
  <text x="410" y="460" text-anchor="middle" class="dim">Slot annotations carry enough information for UI generation, persistence, and synchronization to be handled automatically.</text>
</svg>
...
For full details on posting, observing, scheduling, and weak reference cleanup, see the [Notifications](../Notifications/) guide. For sync loop detection, see the [Views](../Views/) guide.
