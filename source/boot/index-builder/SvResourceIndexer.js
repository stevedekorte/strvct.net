...
const SvResourcesFolder = require("./SvResourcesFolder.js");
//console.log("SvResourcesFolder:", SvResourcesFolder);
const process = require("process");


class SvResourceIndexer extends Object {
    constructor () {
        super();
    }
    ...
    run () {
        ...
        args.forEach(dirPathCommandLineArg => {
            const folder = new SvResourcesFolder();
