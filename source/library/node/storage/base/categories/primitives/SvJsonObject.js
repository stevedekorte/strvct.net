...
/** * @class SvJsonObject_store
 * @extends Object
 * @classdesc A bit of a hack to deal with slots containing JSON objects.
 *
 * Serializing:
 * SvObjectPool will test to see if the object is a JSON object, and if so, will call:
 * record = SvJsonObject.instanceForObject(anObject).recordForStore(aStore);
 *
 * Unserializing:
 * SvObjectPool will call instanceFromRecordInStore() which will return a JSON object.
 *
 * NOTES:
...
(class SvJsonObject extends ProtoClass {
