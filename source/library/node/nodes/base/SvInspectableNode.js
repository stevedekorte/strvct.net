...
/** * @class SvInspectableNode
 * @extends SvTranslatableNode
 * @classdesc SvInspectableNode
 *
 * Handles creating inspector nodes and related fields.
 * Slot has some logic for this too.
 *
 * Inheritance chain:
 * SvNode -> SvTitledNode -> SvTranslatableNode -> SvInspectableNode -> SvViewableNode -> SvStyledNode -> SvBaseNode -> StorableNode
 ...
 */
(class SvInspectableNode extends SvTranslatableNode {

    /**
     * @description Initializes the prototype slots for the SvInspectableNode.
     ...
     * @returns {SvInspectableNode} This instance.
     * @category Inspection
     */
