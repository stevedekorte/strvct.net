...
/** * @class SvTilesView_gestures
 * @extends SvTilesView
 * @classdesc
 * SvTilesView_gestures
 *
 * This class extends SvTilesView to add gesture handling functionality.
...
(class SvTilesView_gestures extends SvTilesView {
     ...
     * @returns {boolean|SvTilesView_gestures} Returns true or the instance itself.
     ...
     * @returns {SvTilesView_gestures} The instance itself.
     * @category SvTile Management
     */
    didReorderTiles () {
    ...
    onPinchBegin (aGesture) { // pinch apart to insert a new tile
        // TODO: move tile specific code to SvTile
