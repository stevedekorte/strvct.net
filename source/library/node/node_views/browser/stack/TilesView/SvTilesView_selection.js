...
(class SvTilesView_selection extends SvTilesView {
     ...
     * @returns {SvTile} The last selected tile.
     */
    lastSelectedTile () {
     ...
     * @param {SvTile} anItem - The shift-tapped item.
     * @returns {SvTilesView_selection} The current instance.
     */
     ...
     * @param {SvTile} anItem - The meta-tapped item.
     */
     ...
     * @param {SvTile} selectedTile - The tile to keep selected.
     * @returns {SvTilesView_selection} The current instance.
     */
     ...
     * @param {Array<SvTile>} tilesToSelect - The tiles to keep selected.
     * @returns {SvTilesView_selection} The current instance.
     */
     ...
     * @returns {Array<SvTile>} An array of selected tiles.
     */
    selectedTiles () {
        let tiles = this.tiles().filter(tile => tile.thisClass().isSubclassOf(SvTile));
     ...
     * @returns {SvTile|null} The selected tile, or null if none or multiple are selected.
     */
    selectedTile () {
     ...
     * @returns {SvTile|null} The selected tile, or null if not found.
     */
     ...
     * @returns {SvTile|null} The next tile, or null if there is no next tile.
     */
    nextTile () {
     ...
     * @returns {SvTile|null} The first tile, or null if there are no tiles.
     */
    firstTile () {
