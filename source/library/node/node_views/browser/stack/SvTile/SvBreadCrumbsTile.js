 ...
 * Registers for onStackViewPathChange notifications (sent by top SvStackView) to auto update path.
 * TODO: register *only* for our own top stack view.
 */
(class SvBreadCrumbsTile extends SvTile {
    ...
    /**
     * @description Initializes the SvBreadCrumbsTile
     * @returns {SvBreadCrumbsTile}
     * @category Initialization
     */
    init () {
        super.init();
        this.setThemeClassName("SvBreadCrumbsTile");
    ...
    */
     ...
     * @param {SvDomView} view - The view to animate
     * @returns {SvBreadCrumbsTile}
     * @category Animation
     */
    applyFadeInAnimation (view) {
        ...
        this.addWeakTimeout(() => {
            view.addCssClass("SvBreadCrumbsTile-fadeIn");
            view.setOpacity(1);
        }, 10);

        // Remove the animation class after animation completes
        this.addWeakTimeout(() => {
            view.removeCssClass("SvBreadCrumbsTile-fadeIn");
