...
/** * @class SvTileTitleView
 * @extends SvTextView
 * @classdesc A title element in a SvTile.
 *
...
(class SvTileTitleView extends SvTextView {
    ...
    /**
     * @description Initializes prototype slots for the SvTileTitleView.
    ...
    /**
     * @description Initializes the prototype for the SvTileTitleView.
     * @category Initialization
     */
    initPrototype () {
    ...
    /**
     * @description Initializes the SvTileTitleView instance.
     * @returns {SvTileTitleView} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
