 ...
 * @classdesc Base tile view. This is a sort of empty canvas for subclasses to put subviews in.
    ...
    SvTile supports tile features such as:
...
(class SvTile extends SvNodeView {
    ...
    initPrototypeSlots () {
        ...
        {
            /**
             * @member {SvDomView} dragDeleteButtonView
    ...
    applyStyles () {
        ...
        // also, SvNodeView should override this method to give node a chance to override style
    ...
    */
    ...
    init () {
        ...
        */
        ...
        /*
        if (SvTouchScreen.shared().isSupported() || true) { // testing
            //
        } else {
            //this.addCloseButton()
        }
        */
        ...
        this.addGestureRecognizer(SvLongPressGestureRecognizer.clone()); // for long press & pan reordering
        this.addGestureRecognizer(SvSlideGestureRecognizer.clone()); // for slide delete
        //this.addGestureRecognizer(SvTapGestureRecognizer.clone()) // for selection, and tap-longpress
    ...
    */
     ...
     * @returns {SvTile} The duplicated tile.
     */
    ...
    // -- contentView --
    // a special subview within the SvTile for it's content
    // we route style methods to it

    /**
     * @description Sets up the content view, a special subview within the SvTile for it's content.
     * We route style methods to it.
     */
    setupTileContentView () {
        const cv = SvFlexDomView.clone().setElementClassName("TileContentView");
        cv.setDisplay("flex");
        cv.setHeight("auto");
    ...
    */
     ...
     * @param {SvDomView} aView - The view to add.
     ...
     * @param {SvDomView} aView - The view to remove.
     * @returns {SvTile} The current instance.
     */
    ...
    */
     ...
     * @param {SvDomView} aView - The view.
     ...
     * @returns {SvDomView} The node tile link.
     */
    nodeTileLink () {
