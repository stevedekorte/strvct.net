...
/**
 * @class SvTile_gestures
 * @extends SvTile
 * @classdesc Extends SvTile with gesture handling functionality.
 */
(class SvTile_gestures extends SvTile {
    ...
    onLongPressComplete (longPressGesture) {
        ...
        this.activate();
        const dv = SvDragView.clone().setItems(this.column().selectedTiles()).setSource(this.column());
