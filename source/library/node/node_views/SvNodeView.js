...
(class SvNodeView extends SvStyledDomView {
    ...
    /**
     * @description Initializes the prototype slots for the SvNodeView.
     */
    initPrototypeSlots () {
        /**
         * @member {SvNode} node
         ...
         */
        {
            ...
            slot.setSlotType("SvDomView class");
        }
    ...
    /**
     * @description Initializes the SvNodeView.
     ...
     * @returns {SvNodeView} The subview for the node.
     */
     ...
     * @returns {SvNodeView} The new subview.
     */
