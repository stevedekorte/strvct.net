 ...
 * @class SvGamePad
 * @extends SvDevice
 * @classdesc A single SvGamePad with a unique id.
 */
(class SvGamePad extends SvDevice {

    /**
     * @description Initializes the prototype slots for the SvGamePad class.
     * @private
    ...
    /**
     * @description Initializes the SvGamePad instance.
     * @returns {SvGamePad} The initialized SvGamePad instance.
     * @category Initialization
     */
    init () {
        super.init();
    ...
    /**
     * @description Updates the SvGamePad data.
    ...
    /**
     * @description Updates the buttons of the SvGamePad.
     * @param {Array} newButtons - The new button states.
     * @returns {SvGamePad} The current SvGamePad instance.
     * @category Update
     */
    ...
    /**
     * @description Updates the axes of the SvGamePad.
    ...
    /**
     * @description Handles the connected event for the SvGamePad.
     * @returns {SvGamePad} The current SvGamePad instance.
     * @category Event
     */
    onConnected () {
    ...
    /**
     * @description Handles the disconnected event for the SvGamePad.
     * @returns {SvGamePad} The current SvGamePad instance.
     * @category Event
     */
    onDisconnected () {
