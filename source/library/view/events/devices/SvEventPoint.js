 ...
 */
(class SvEventPoint extends SvPoint {
    /**
     * @description Initializes the prototype slots for the SvEventPoint class.
     */
    initPrototypeSlots () {
        /**
        ...
        /**
         * @member {SvDomView} overView - The view the event point is over.
         * @category DOM
         */
        {
    ...
    */
    ...
    /**
     * @description Copies properties from another SvEventPoint instance.
     * @param {SvEventPoint} p - The SvEventPoint to copy from.
     * @param {Object} copyDict - The dictionary used for copying.
     * @returns {SvEventPoint} This instance.
     ...
     * @returns {SvDomView|null} The view or null if not found.
     * @category DOM
     */
    overView () {
     ...
     * @returns {SvDomView|null} The found view or null if not found.
     * @category DOM
     */
    findOverview () {
     ...
     * @returns {SvPoint} The viewport position.
     * @category Viewport
     */
    viewportPosition () {
        const e = this.event();
        const p = SvPoint.clone().set(e.clientX, e.clientY);
        return p;
    }
