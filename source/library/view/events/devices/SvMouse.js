...
(class SvMouse extends SvDevice {
    ...
    /**
     * @description Initializes the prototype slots for the SvMouse class.
     * @category Initialization
     */
    initPrototypeSlots () {
        /**
        ...
        /**
         * @member {SvMouseListener} mouseListener - The mouse listener instance.
         * @category Event Handling
         */
        {
            const slot = this.newSlot("mouseListener", null);
            slot.setSlotType("SvMouseListener");
        }
        /**
         * @member {SvMouseMoveListener} mouseMoveListener - The mouse move listener instance.
         * @category Event Handling
         */
        {
            const slot = this.newSlot("mouseMoveListener", null);
            slot.setSlotType("SvMouseMoveListener");
        }
    }

    /**
     * @description Initializes the SvMouse instance and starts listening for events.
     * @returns {SvMouse} The initialized SvMouse instance.
     * @category Initialization
     */
    init () {
        super.init();
    ...
    */
     ...
     * @returns {SvMouse} The SvMouse instance.
     * @category Event Handling
     */
    startListening () {
        this.setMouseListener(SvMouseListener.clone().setUseCapture(true).setListenTarget(document.body).setDelegate(this));
        this.mouseListener().setIsListening(true);

        this.setMouseMoveListener(SvMouseMoveListener.clone().setUseCapture(true).setListenTarget(document.body).setDelegate(this));
     ...
     * @returns {SvEventPoint} The converted point.
     * @category Utilities
     */
    pointForEvent (event) {
     ...
     * @param {MouseEvent} event - The mouse event.
     * @returns {SvPoint} The drag vector.
     * @category Utilities
     */
    dragVector (event) {
        if (this.downPos()) {
        ...
        */
        return SvPoint.clone();
    }

    /**
     * @description Gets the points for a given event.
     * @param {MouseEvent} event - The mouse event.
     * @returns {Array<SvEventPoint>} An array of points for the event.
     * @category Utilities
     */
     ...
     * @returns {Array<SvEventPoint>} An array of current points.
     * @category Utilities
     */
    currentPoints () {
