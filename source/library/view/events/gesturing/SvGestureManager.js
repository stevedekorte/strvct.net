...
/**
 * @class SvGestureManager
 * @extends ProtoClass
 * @classdesc SvGestureManager coordinates which gesture has control globally.
 *
 * We typically only want one gesture to be active globally.
 * SvGestureManager helps to coordinate which gesture has control.
 *
 * To pause all gestures:
 *
 *     SvGestureManager.shared().pause()
 *     SvGestureManager.shared().unpause()
 *
 * or:
 *
 *     SvGestureManager.shared().setIsPaused(aBool)
 *
 * NOTES:
 *
 * If a descendant view requests control, it can steal it.
 */
(class SvGestureManager extends ProtoClass {
    ...
    initPrototypeSlots () {
         ...
         */
        {
            ...
            slot.setSlotType("SvGestureRecognizer");
        }
        /**
     ...
     * @returns {SvGestureManager} The instance
     * @category Initialization
     */
    init () {
        super.init();
