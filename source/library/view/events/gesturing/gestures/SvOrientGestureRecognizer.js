...
/**
 * @class SvOrientGestureRecognizer
 * @extends SvGestureRecognizer
 * @classdesc
 * SvOrientGestureRecognizer
 *
 ...
 */
(class SvOrientGestureRecognizer extends SvGestureRecognizer {
    ...
    /**
     * @description Initializes the SvOrientGestureRecognizer
     * @returns {SvOrientGestureRecognizer} The initialized instance
     * @category Initialization
     */
    init () {
        super.init();
     ...
     * @returns {SvOrientGestureRecognizer} The instance
     ...
     * @returns {SvPoint} The center point
     * @category SvPoint Calculation
     */
    centerForPoints (p) {
     ...
     * @returns {SvPoint} The down center position
     ...
     * @returns {SvPoint} The begin center position
     * @category Position Calculation
     */
    beginCenterPosition () {
     ...
     * @returns {SvPoint} The current center position
     * @category Position Calculation
     */
     ...
     * @returns {SvPoint} The difference position
     * @category Position Calculation
     */
    diffPosition () {
