...
/**
 * @class SvSlideGestureRecognizer
...
(class SvSlideGestureRecognizer extends SvGestureRecognizer {
    ...
    initPrototypeSlots () {
        ...
        //downPositionInTarget: null, SvPoint
    }

    /**
     * @description Initializes the SvSlideGestureRecognizer
     * @returns {SvSlideGestureRecognizer} The initialized instance
     ...
     * @returns {SvSlideGestureRecognizer} The instance
     * @category Configuration
     */
     ...
     * @returns {SvPoint} The difference in position
     * @category Gesture Recognition
     */
    diffPos () {
