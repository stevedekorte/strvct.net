...
/**
 * @class SvTapGestureRecognizer
 * @extends SvGestureRecognizer
 * @classdesc
 * SvTapGestureRecognizer
 *
 ...
 */
(class SvTapGestureRecognizer extends SvGestureRecognizer {

    /**
     * @description Initializes the prototype slots for the SvTapGestureRecognizer.
     * @private
    ...
    /**
     * @description Initializes the SvTapGestureRecognizer.
     * @returns {SvTapGestureRecognizer} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
     ...
     * @returns {SvTapGestureRecognizer} The instance.
