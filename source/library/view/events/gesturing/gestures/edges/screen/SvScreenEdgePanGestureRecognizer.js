...
/**
 * @class SvScreenEdgePanGestureRecognizer
 * @extends SvPanGestureRecognizer
 * @classdesc Subclass of SvPanGestureRecognizer that limits pan detection to gestures starting at the edge.
...
(class SvScreenEdgePanGestureRecognizer extends SvPanGestureRecognizer { // TODO abstract PanEdgeGestureRecognizer
     ...
     * @returns {SvScreenEdgePanGestureRecognizer} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
     ...
     * @returns {SvScreenEdgePanGestureRecognizer} The instance.
     * @category Lifecycle
     */
    start () {
