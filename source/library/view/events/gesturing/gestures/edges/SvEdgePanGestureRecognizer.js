...
/**
 * @class SvEdgePanGestureRecognizer
 * @extends SvPanGestureRecognizer
 * @classdesc Subclass of SvPanGestureRecognizer that limits pan detection to gestures starting at the edge of the view.
 ...
 *     onEdgePanCancelled
 */
(class SvEdgePanGestureRecognizer extends SvPanGestureRecognizer {
     ...
     * @returns {SvEdgePanGestureRecognizer} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
     ...
     * @returns {SvEdgePanGestureRecognizer} The instance.
     * @category Lifecycle
     */
    start () {
        return super.start();
