...
/**
 * @class SvRotationGestureRecognizer
 * @extends SvGestureRecognizer
 * @classdesc SvRotationGestureRecognizer overrides SvOrientGestureRecognizer's hasMovedEnough() method to
 ...
 */
(class SvRotationGestureRecognizer extends SvGestureRecognizer {
    ...
    /**
     * @description Initializes the SvRotationGestureRecognizer
     * @returns {SvRotationGestureRecognizer} The initialized instance
     * @category Initialization
     */
    init () {
        super.init();
