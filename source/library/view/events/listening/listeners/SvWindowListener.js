 ...
 */
(class SvWindowListener extends SvEventSetListener {
     ...
     * @returns {SvWindowListener} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
     ...
     * @returns {SvWindowListener} The instance with set up listeners.
