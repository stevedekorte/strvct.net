 ...
 * Example use of:
 *
 *     const mouseListener = SvMouseListener.clone().setListenTarget(element).setDelegate(anObject)
 *
 ...
 */
(class SvEventSetListener extends ProtoClass {
    ...
    initPrototypeSlots () {
        ...
        /**
         * @member {Map} listenersMap - Map of eventName -> SvEventListener entries
         * @category State
         */
        {
    ...
    /**
     * @description Initializes the SvEventSetListener
     * @returns {SvEventSetListener}
     * @category Lifecycle
     */
    init () {
        super.init();
    ...
    */
    ...
    /**
     * @description Creates a new SvEventListener
     * @returns {SvEventListener}
     * @category Listeners
     */
    newListener () {
        const listener = SvEventListener.clone();
     ...
     * @param {SvEventListener} aListener - The listener to sync
     * @returns {SvEventSetListener}
     * @category Listeners
     */
