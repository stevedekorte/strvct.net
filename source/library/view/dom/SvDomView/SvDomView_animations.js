...
/**
 * @class SvDomView_animations
 * @extends SvDomView
 * @classdesc Helper methods for animations.
 */
(class SvDomView_animations extends SvDomView {

    /**
     * @description Immediately scrolls the view to the bottom.
     * @returns {SvDomView_animations} The instance of the class.
     * @category Scrolling
     */
    immediatelyScrollToBottom () {
        ...
        // only logs when this call moves the viewport by more than a
        // screenful (routine stick-to-bottom is silent)
     ...
     * @param {SvDomView} aSubview - The subview to scroll to the top.
     * @returns {SvDomView_animations} The instance of the class.
     * @category Scrolling
     */
     ...
     * @returns {boolean|SvDomView_animations} False if already in view, otherwise the instance of the class.
     * @category Scrolling
     */
    scrollIntoView () {
        ...
        this.addWeakTimeout(() => {
            ...
            //SvThrashDetector.shared().didOp("scrollIntoView")
