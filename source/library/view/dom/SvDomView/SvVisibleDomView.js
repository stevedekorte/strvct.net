...
/**
 * @class SvVisibleDomView
 * @extends SvListenerDomView
 * @classdesc Support for visibility events.
 */
(class SvVisibleDomView extends SvListenerDomView {

    /**
     * @description Initializes the prototype slots for the SvVisibleDomView.
