...
(class SvResponderDomView extends SvGesturableDomView {
    ...
    initPrototypeSlots () {
        ...
        */
        /**
         * @member {SvResponderDomView} nextKeyView
         * @category Focus Management
         */
        {
            const slot = this.newSlot("nextKeyView", null);
            slot.setSlotType("SvResponderDomView");
        }
        /*
        {
