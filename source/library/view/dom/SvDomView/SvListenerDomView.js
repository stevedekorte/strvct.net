 ...
 *
 * @class SvListenerDomView
 * @extends SvSubviewsDomView
 * @classdesc Handles event listeners for DOM views
 */
(class SvListenerDomView extends SvSubviewsDomView {
    ...
    /**
     * @description Initializes the SvListenerDomView
     * @returns {SvListenerDomView} The initialized instance
     */
    init () {
        super.init();
     ...
     * @returns {SvListenerDomView} The current instance
     */
    removeAllListeners () {
     ...
     */
    animationListener () {
        return this.listenerNamed("SvAnimationListener");
    }
     ...
     */
    clipboardListener () {
        return this.listenerNamed("SvClipboardListener");
    }
     ...
     */
    windowListener () {
        return this.listenerNamed("SvWindowListener"); // listen target will be the window
    }
     ...
     */
    documentListener () {
        return this.listenerNamed("SvDocumentListener"); // listen target will be the window
    }
     ...
     */
    browserDragListener () {
        return this.listenerNamed("SvDragListener");
    }
     ...
     */
    dropListener () {
        return this.listenerNamed("SvDropListener");
    }
     ...
     */
    focusListener () {
        return this.listenerNamed("SvFocusListener");
    }
     ...
     */
    mouseListener () {
        return this.listenerNamed("SvMouseListener");
    }
     ...
     */
    mouseMoveListener () {
        return this.listenerNamed("SvMouseMoveListener");
    }
     ...
     */
    keyboardListener () {
        return this.listenerNamed("SvKeyboardListener");
    }
     ...
     */
    scrollListener () {
        return this.listenerNamed("SvScrollListener");
    }
     ...
     */
    selectListener () {
        return this.listenerNamed("SvSelectListener");
    }
     ...
     */
    touchListener () {
        return this.listenerNamed("SvTouchListener");
    }
     ...
     */
    transitionListener () {
        return this.listenerNamed("SvTransitionListener");
    }
    ...
    */
     ...
     */
    onMouseDown (event) {
        const methodName = SvMouse.shared().downMethodNameForEvent(event);
     ...
     */
    onMouseUp (event) {
        const methodName = SvMouse.shared().upMethodNameForEvent(event);
    ...
    setIsRegisteredForKeyboard (aBool, useCapture = false) {
        ...
        if (aBool) {
            SvDomView.setTabCount(SvDomView.tabCount() + 1);
            e.tabIndex = SvDomView.tabCount();  // need this in order for focus to work on BrowserColumn?
    ...
    setIsRegisteredForFocus (aBool) {
        if (aBool === false && !this.hasListenerNamed("SvFocusListener")) { // todo: clean this up
            return;
        }
