 ...
 */
(class SvDragBarView extends SvDomView {

    /**
     * @description Initializes the prototype slots for the SvDragBarView.
    ...
    /**
     * @description Initializes the SvDragBarView.
     * @returns {SvDragBarView} The initialized SvDragBarView instance.
     * @category Initialization
     */
    init () {
        super.init();
        ...
        this.setElementClassName("SvDragBarView");
     ...
     * @returns {SvDragBarView} The SvDragBarView instance.
     * @category Behavior
     */
    setIsVertical (aBool) {
