...
/**
 * @class SvCanvasTextTapeMeasure
 * @extends ProtoClass
 * @classdesc Used to measure rendered text dimensions given a string and a style.
 *
 * Example uses:
 *
 *     const width = SvCanvasTextTapeMeasure.shared().getTextWidth(text, fontString);
 */
(class SvCanvasTextTapeMeasure extends ProtoClass {
    ...
    /**
     * @description Initializes the SvCanvasTextTapeMeasure instance.
     * @returns {SvCanvasTextTapeMeasure} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
    ...
    /**
     * @static
     * @description Performs a self-test of the SvCanvasTextTapeMeasure class.
     * @returns {SvCanvasTextTapeMeasure} The class itself.
     * @category Testing
     */
    static selfTest () {
        const tape = SvCanvasTextTapeMeasure.clone();
...
//SvCanvasTextTapeMeasure.selfTest()
