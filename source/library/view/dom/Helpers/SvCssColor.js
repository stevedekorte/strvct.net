 ...
 */
(class SvCssColor extends ProtoClass {
    ...
    /**
     * @description Initializes the SvCssColor instance
     * @returns {SvCssColor} The initialized instance
     */
    init () {
        super.init();
     ...
     * @returns {SvCssColor} The instance with randomized color
     */
    randomize () {
    ...
    /**
     * @description Creates a copy of another SvCssColor instance
     * @param {SvCssColor} aColor - The color to copy from
     * @param {Object} copyDict - Copy options (not used in this method)
     * @returns {SvCssColor} A new SvCssColor instance with copied values
     */
    copyFrom (aColor /*, copyDict*/) {
        return SvCssColor.clone().set(aColor.red(), aColor.green(), aColor.blue(), aColor.opacity());
    }
    ...
    parseColorString (string) {
        const cache = SvCssColor.colorCacheMap();
     ...
     * @returns {SvCssColor} The instance with updated color
     */
     ...
     * @param {SvCssColor} other - The other color to interpolate with
     * @param {number} v - Interpolation value (0-1)
     * @returns {SvCssColor} New interpolated color
     */
    interpolateWithColorTo (other, v) {
        ...
        const result = SvCssColor.clone().set(r, g, b, o);
        return result;
    }
     ...
     * @returns {SvCssColor} The darkened color instance
     */
    darken (v) {
        assertDefined(v);
        assert(v <= 1);
     ...
     * @returns {SvCssColor} The lightened color instance
     */
    lighten (v) {
        assertDefined(v);
        const r = this.red();
     ...
     * @returns {SvCssColor} A new white color instance
     */
    whiteColor () {
        return SvCssColor.clone().set(1, 1, 1, 1);
    }

    /**
     * @description Creates a black color
     * @returns {SvCssColor} A new black color instance
     */
    blackColor () {
        return SvCssColor.clone().set(0, 0, 0, 1);
    }

    /**
     * @description Creates a light gray color
     * @returns {SvCssColor} A new light gray color instance
     */
    lightGrayColor () {
        return SvCssColor.clone().set(0.75, 0.75, 0.55, 1);
    }

    /**
     * @description Creates a gray color
     * @returns {SvCssColor} A new gray color instance
     */
    grayColor () {
        return SvCssColor.clone().set(0.5, 0.5, 0.5, 1);
    }

    /**
     * @description Creates a dark gray color
     * @returns {SvCssColor} A new dark gray color instance
     */
    darkGrayColor () {
        return SvCssColor.clone().set(0.25, 0.25, 0.25, 1);
    }

    /**
     * @description Creates a red color
     * @returns {SvCssColor} A new red color instance
     */
    redColor () {
        return SvCssColor.clone().set(1, 0, 0, 1);
    }

    /**
     * @description Creates a green color
     * @returns {SvCssColor} A new green color instance
     */
    greenColor () {
        return SvCssColor.clone().set(0, 1, 0, 1);
    }

    /**
     * @description Creates a blue color
     * @returns {SvCssColor} A new blue color instance
     */
    blueColor () {
        return SvCssColor.clone().set(0, 0, 1, 1);
    }

    /**
     * @description Creates a yellow color
     * @returns {SvCssColor} A new yellow color instance
     */
    yellowColor () {
        return SvCssColor.clone().set(1, 1, 0, 1);
    }

    /**
     * @description Creates a random color
     * @returns {SvCssColor} A new random color instance
     */
    randomColor () {
        return SvCssColor.clone().randomize();
    }
     ...
     * @returns {SvCssColor} A new SvCssColor instance with the complement color
     */
    complement () {
        ...
        return SvCssColor.clone().fromDict255(temprgb);
    }

    /**
     * @description Creates a contrasting complement of the current color
     * @param {number} v - Amount of contrast (0-1)
     * @returns {SvCssColor} A new SvCssColor instance with the contrasting complement color
     */
    contrastComplement (v) { // v should be a value in the range of 0.0 to 1.0
        // returns another SvCssColor object which is the same as the receiver but darkened
        //
