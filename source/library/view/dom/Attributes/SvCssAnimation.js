 ...
 * The rule name is a hash of the rule content, and the SvCssAnimation class keeps a set of names
 * it's already registered, so it doesn't register them again.
 *
 * Example use:
 *
 *     SvCssAnimation.clone().setPropertyName("right").setTargetValue("10px").setView(aView).start()
 */
"use strict";

(class SvCssAnimation extends ProtoClass {

    /**
     * @static
     * @description Inserts a rule for the given CSS animation
     * @param {SvCssAnimation} cssAnimation - The CSS animation object
     * @returns {SvCssAnimation} - The SvCssAnimation class
     * @category Animation
     */
     ...
     * @param {SvDomView} aView - The view to apply the animation to
     * @category Animation
     */
    applyToView (aView) {
     ...
     * @returns {SvCssAnimation} The SvCssAnimation instance
     * @category Animation
     */
    start () {
        this.insertRule();
