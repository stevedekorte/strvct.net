 ...
 */
(class SvDomBorderRadius extends ProtoClass {
    /**
     * @description Initializes the prototype slots for the SvDomBorderRadius class.
     */
    initPrototypeSlots () {
        /**
         * @member {SvDomView} divView - The associated SvDomView.
         * @category View
         */
        {
    ...
    */
     ...
     * @returns {SvDomBorderRadius} The current instance.
    ...
    /**
     * @description Synchronizes the border radius values to the associated SvDomView.
     * @returns {SvDomBorderRadius} The current instance.
    ...
    /**
     * @description Synchronizes the border radius values from the associated SvDomView.
     * @returns {SvDomBorderRadius} The current instance.
     * @category Synchronization
     */
    syncFromDomView () {
