...
/**
 * @class SvStyledDomView
 * @extends SvFlexDomView
 * @classdesc SvStyledDomView
 *
 ...
 * - disabled
 */
(class SvStyledDomView extends SvFlexDomView {

    /**
     * @description Initializes the prototype slots for the SvStyledDomView.
    ...
    /**
     * @description Initializes the SvStyledDomView.
     ...
     * @param {SvStyledDomView} aView - The view that was activated.
     * @category Event
     */
