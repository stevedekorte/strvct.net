 ...
 *     // the SvDragView will set it's destination slot before calling these
 *
 ...
 *     const dv = SvDragView.clone().setItem(this).setSource(this.column())
 *     dv.openWithEvent(longPressGesture.currentEvent()) // TODO: eliminate this step?
 * }
 */
(class SvDragView extends SvStyledDomView {
    ...
    initPrototypeSlots () {
        ...
        /**
         * @member {SvDomView} source - The view which is the owner of the view being dragged that implements the source protocol
         */
        {
            const slot = this.newSlot("source", null);
            slot.setSlotType("SvDomView"); // TODO: make this a protocol
        }

        /**
         * @member {SvDomView} destination - The view on which the item is dropped
         */
        {
        ...
        /**
         * @member {SvPoint} dragStartPos - Start position in screen coordinates
         */
        {
        ...
        /**
         * @member {Boolean} isClosed - Indicates whether the SvDragView is closed
         */
        {
    ...
    /**
     * @description Initializes the SvDragView
     * @returns {SvDragView} The initialized SvDragView instance
     */
    init () {
        super.init();
        this.setHoverViews([]);
     ...
     * @param {SvDomView} aView - The view to be dragged
     * @returns {SvDragView} The SvDragView instance
     */
    setItem (aView) {
        this.setItems([aView]);
        return this;
     ...
     * @returns {SvDomView} The first item
     */
    item () {
    ...
    /**
     * @description Checks if the SvDragView has a pan gesture
    ...
    /**
     * @description Opens the SvDragView with a given event
    ...
    /**
     * @description Checks if the SvDragView accepts pan gestures
    ...
    /**
     * @description Opens the SvDragView
     * @returns {SvDragView} The SvDragView instance
     */
    open () {
        this.setupView();
    ...
    /**
     * @description Updates the position of the SvDragView
     * @private
     */
    updatePosition () {
     ...
     * @returns {SvDomView|null} The first accepting drop target or null if none found
     * @private
     */
    ...
    viewsUnderDefaultPan () {
        return SvDocumentBody.shared().viewsUnderPoint(this.dropPoint());
    }

    /**
     * @description Gets the current drop point
     * @returns {SvPoint} The current drop point
     * @private
     */
     ...
     * @returns {SvDragView} The current instance.
     */
    hoverOverViews () {
     ...
     * @param {SvDomView} aView - The view to send the action to.
     ...
     * @param {SvDomView} receiver - The receiver of the message.
    ...
    /**
     * @description Closes the SvDragView.
     * @returns {SvDragView} The current instance.
     */
    close () {
        this.logDebug("close");
        ...
        this.removePanStyle();
        SvDocumentBody.shared().removeSubview(this);
    ...
    /**
     * @description Adds a pan style to the SvDragView.
     * @returns {SvDragView} The current instance.
     */
    addPanStyle () {
    ...
    /**
     * @description Removes the pan style from the SvDragView.
     * @returns {SvDragView} The current instance.
     */
    removePanStyle () {
        const s = "none";
