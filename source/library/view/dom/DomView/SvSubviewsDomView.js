...
(class SvSubviewsDomView extends SvCssDomView {
    ...
    initPrototypeSlots () {
        /**
         * @member {SvDomView} parentView - The parent view.
         */
        {
     ...
     * @param {SvDomView} oldValue - The old parent view.
     * @param {SvDomView} newValue - The new parent view.
     * @returns {SvSubviewsDomView} The updated view.
     */
    ...
    */
     ...
     * @param {SvDomView} aView - The view to check.
     ...
     * @param {SvDomView} aSubview - The subview to check.
     ...
     * @param {SvDomView} aSubview - The subview to add.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} sv1 - The first subview.
     * @param {SvDomView} sv2 - The second subview.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} aSubview - The subview to move to the front.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} aSubview - The subview to move to the back.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} oldSubview - The subview to replace.
     * @param {SvDomView} newSubview - The new subview.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} aSubview - The subview to insert.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} aSubview - The subview to move.
     ...
     * @param {SvDomView} exceptedSubview - The subview to exclude from the action.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} aSubview - The subview to remove.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} aSubview - The subview to find.
     ...
     * @param {SvDomView} aSubview - The subview to find the next subview after.
     * @returns {SvDomView} The next subview, or null if not found.
     */
     ...
     * @param {SvDomView} aView - The view to tell.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @param {SvDomView} aView - The view to ask.
     * @returns {SvSubviewsDomView} The updated view.
     */
    ...
    */
     ...
     * @returns {SvDomView} The root view.
     */
    rootView () {
        const pv = this.parentView();
        if (pv) {
     ...
     */
    isInDocument () {
        return this.rootView() === SvDocumentBody.shared();
    }
    ...
    containerize () {
        ...
        const container = SvDomView.clone();
     ...
     * @param {SvDomView} aView - The view to move the subviews to.
     * @returns {SvSubviewsDomView} The updated view.
     */
     ...
     * @returns {SvDomView} The duplicated view.
     */
    htmlDuplicateView () {
     ...
     */
    resyncAllViews () {
        this.updateSubviews(); // SvNodeView already does this when it schedules syncFromNode, so don't call from SvNodeView
     ...
     * @param {SvDomView} parentView - The parent view.
    ...
    setParentViewIfTrue (parentView, aBool) {
        /*
         ...
         which useful to avoid an excessively larger DOM tree, especially in repeated elements like Tiles in a SvScrollView.
