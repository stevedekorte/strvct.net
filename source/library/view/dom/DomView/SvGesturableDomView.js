...
/**
 * @class SvGesturableDomView
 * @extends SvVisibleDomView
 * @classdesc SvGesturableDomView class for handling gestures
 */
(class SvGesturableDomView extends SvVisibleDomView {

    /**
     * @description Initializes the prototype slots for the SvGesturableDomView
    ...
    initPrototypeSlots () {
        ...
        {
            /**
             * @member {SvTapGestureRecognizer} defaultTapGesture - Default tap gesture recognizer
             * @category Gesture Management
             */
            const slot = this.newSlot("defaultTapGesture", null);
            slot.setSlotType("SvTapGestureRecognizer");
        }
        {
            /**
             * @member {SvTapGestureRecognizer} defaultDoubleTapGesture - Default double tap gesture recognizer
             * @category Gesture Management
             */
        ...
        {
            /**
             * @member {SvPanGestureRecognizer} defaultPanGesture - Default pan gesture recognizer
             * @category Gesture Management
             */
            const slot = this.newSlot("defaultPanGesture", null);
            slot.setSlotType("SvPanGestureRecognizer");
        }
    }
     ...
     * @param {SvGestureRecognizer} gr - Gesture recognizer to check
     ...
     * @param {SvGestureRecognizer} gr - Gesture recognizer to add
     * @returns {SvGestureRecognizer} The added gesture recognizer
     * @category Gesture Management
     */
     ...
     * @param {SvGestureRecognizer} gr - Gesture recognizer to remove
     * @returns {SvGesturableDomView} The current instance
     * @category Gesture Management
     */
     ...
     * @returns {SvTapGestureRecognizer} The default tap gesture recognizer
     * @category Gesture Management
     */
    addDefaultTapGesture () {
        if (!this.defaultTapGesture()) {
            const g = this.addGestureRecognizer(SvTapGestureRecognizer.clone());
     ...
     * @returns {SvTapGestureRecognizer} The new double tap gesture recognizer
     * @private
     * @category Gesture Creation
     */
    newDoubleTapGestureRecognizer () {
        const tg = SvTapGestureRecognizer.clone();
     ...
     * @returns {SvTapGestureRecognizer} The default double tap gesture recognizer
     * @category Gesture Management
     */
     ...
     * @returns {SvPanGestureRecognizer} The default pan gesture recognizer
     * @category Gesture Management
     */
    addDefaultPanGesture () {
        if (!this._defaultPanGesture) {
            this._defaultPanGesture = this.addGestureRecognizer(SvPanGestureRecognizer.clone());
        }
     ...
     * @param {SvGestureRecognizer} aGesture - The gesture to exclude from cancellation
     * @returns {SvGesturableDomView} The current instance
     * @category Gesture Management
     */
