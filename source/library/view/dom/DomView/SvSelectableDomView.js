...
/**
 * @class SvSelectableDomView
 * @extends SvControlDomView
 * @classdesc SvSelectableDomView
 *
 * For subclasses to extend. Ancestors of this class are organizational parts of SvDomView.
 */
(class SvSelectableDomView extends SvControlDomView {
     ...
     * @returns {SvSelectableDomView} The instance for method chaining.
     * @category Selection
     */
     ...
     * @returns {SvSelectableDomView|null} The instance for method chaining or null if not contained.
     * @category Selection
     */
