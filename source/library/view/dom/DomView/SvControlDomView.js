...
/**
 * @class SvControlDomView
 * @extends SvResponderDomView
 * @classdesc SvControlDomView handles target / action state and behavior.
 */
(class SvControlDomView extends SvResponderDomView {
