...
(class SvWebDocument extends ProtoClass {
    ...
    /**
     * @description Returns the shared SvDocumentBody instance.
    ...
    isFullscreen () {
        // Document is in fullscreen mode. Also see SvWebBrowserWindow.isFullscreen().
        return !!(
