...
/**
 * @class SvWebBrowserWindow
 * @extends ProtoClass
 * @classdesc Abstraction for the main web browser window
 * Owns a SvDocumentBody view.
 *
 * Usage example:
 * SvWebBrowserWindow.shared().storeSelectionRange();
 * // do stuff
 * SvWebBrowserWindow.shared().restoreSelectionRange();
 */
(class SvWebBrowserWindow extends ProtoClass {
    ...
    initPrototypeSlots () {
        /**
         * @member {SvWindowListener} windowListener
    ...
    /**
     * @description Initializes the SvWebBrowserWindow instance.
     * @returns {SvWebBrowserWindow} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
        if (SvPlatform.isBrowserPlatform()) {
            ...
            console.log("🟡 SvWebBrowserWindow: init: not in browser environment - skipping setupWindowListener");
        }
        return this;
    }
     ...
     * @returns {SvWebBrowserWindow} The current instance.
     * @category Window Management
     */
    setupWindowListener () {
        this.setWindowListener(SvWindowListener.clone().setDelegate(this).setIsListening(true));
        return this;
    }

    /**
     * @description Gets the shared SvDocumentBody instance.
     * @returns {SvDocumentBody} The shared SvDocumentBody instance.
     * @category Document Management
     */
    documentBody () {
        return SvDocumentBody.shared();
    }
     ...
     */
    setWidth (/*w*/) {
        console.warn("warning: SvWebBrowserWindow.setWidth() unavailable in browser");
        return this;
    }
     ...
     */
    setHeight (/*h*/) {
        console.warn("warning: SvWebBrowserWindow.setHeight() unavailable in browser");
        return this;
    }
    ...
    isFullScreen () {
        // Window is in fullscreen mode. Also see SvWebDocument.isFullscreen().
