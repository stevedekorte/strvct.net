 ...
 *
 * Usage example:
 * SvWebBrowserCookie.shared().setCookie("myCookie", myCookieValue, 400 * 24 * 60 * 60);
 * const myCookieValue = SvWebBrowserCookie.shared().getCookie("myCookie");
 * SvWebBrowserCookie.shared().deleteCookie("myCookie");
 */

(class SvWebBrowserCookie extends ProtoClass {
    ...
    /**
     * @description Initializes the SvWebBrowserCookie instance.
     * @returns {SvWebBrowserCookie} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
     ...
     * @returns {SvWebBrowserCookie} The current instance.
     * @category Cookie Management
     */
