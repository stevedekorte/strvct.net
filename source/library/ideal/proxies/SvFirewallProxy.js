...
/** * @class SvFirewallProxy
 * @extends SvObservableProxy
 * @classdesc
 * SvFirewallProxy
 *
 ...
 *
 *     const array = ["a", "b", "c"]
 *     const proxyRef = SvFirewallProxy.newProxyFor(array)
...
(class SvFirewallProxy extends SvObservableProxy {
     ...
     * @returns {SvFirewallProxy} The initialized instance
     * @category Initialization
     */
    init () {
        super.init();
    ...
    postForTrap (trapName, propertyName) {
        ...
        // TODO: abstract non posting behavior from SvObservableProxy and
        // use as parent class of both SvObservableProxy and Firewall
    ...
    /**
     * @description Self-test for SvFirewallProxy
     * @category Testing
     */
    static selfTest () {
        // test array
...
// ------------------------------------------------------------------
// Use SvFirewallProxy to implement asReadOnly methods on basic types
// ------------------------------------------------------------------
...
Object.defineSlots(Object.prototype, {
     ...
     * @returns {SvFirewallProxy} A read-only proxy for the object
     * @category Proxy Creation
     */
    asReadOnly () {
        const obj = SvFirewallProxy.newProxyFor(this);
