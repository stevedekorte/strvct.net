 ...
 *     const proxyRef = SvObservableProxy.newProxyFor(myObject)
...
(class SvObservableProxy extends ProtoClass {
     ...
     * @returns {SvObservableProxy} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
     ...
     * @returns {SvObservableProxy} The current instance.
     * @category Proxy
     */
    revoke () {
    ...
    */
    ...
    /**
     * @description Performs a self-test of the SvObservableProxy class.
    ...
    static selfTest () {
        ...
        const noteNamesDict = SvObservableProxy.clone().noteNamesDict();
        ...
        const arrayProxy = SvObservableProxy.newProxyFor(testArray);
