...
SvGlobals.globals().ideal.SvAtomicMap = class SvAtomicMap extends ProtoClass {
     ...
     * @description Initializes the SvAtomicMap.
     */
    init () {
        super.init();
        this.setMap(new Map());
    ...
    /**
     * @category Mutation
     * @description Opens the SvAtomicMap for operations.
     * @returns {SvAtomicMap} This instance of SvAtomicMap.
     */
    open () {
        this.setIsOpen(true);
        return this;
    ...
    /**
     * @category Assertion
     * @description Asserts that the SvAtomicMap is open for operations.
     * @throws {Error} If the SvAtomicMap is not open.
     */
    assertAccessible () {
        this.assertOpen();
    }
     ...
     * @async
     * @category Promise
     * @description Promises to open the SvAtomicMap for operations.
     * @returns {Promise} A Promise that resolves when the SvAtomicMap is open.
     */
    async promiseOpen () {
        this.open();
    }
    ...
    /**
     * @category Mutation
     * @description Closes the SvAtomicMap for operations.
     * @returns {SvAtomicMap} This instance of SvAtomicMap.
     */
    close () {
     ...
     * @async
     * @category Promise
     * @description Begins a transaction on the SvAtomicMap.
    ...
    /**
     * @category Assertion
     * @description Asserts that the SvAtomicMap is in a transaction.
     * @throws {Error} If the SvAtomicMap is not in a transaction.
     * @private
     */
    assertInTx () {
	    assert(this.isInTx());
    ...
    /**
     * @category Assertion
     * @description Asserts that the SvAtomicMap is not in a transaction.
     * @throws {Error} If the SvAtomicMap is in a transaction.
     * @private
     */
    assertNotInTx () {
	    assert(!this.isInTx());
    ...
    /**
     * @category Testing
     * @description Runs a self-test on the SvAtomicMap class.
