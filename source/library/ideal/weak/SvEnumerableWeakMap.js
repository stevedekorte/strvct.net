...
SvGlobals.globals().SvEnumerableWeakMap = (class SvEnumerableWeakMap extends Object {
    ...
    /**
   * Creates an instance of SvEnumerableWeakMap.
   ...
   */
    ...
    /**
   * Clears the SvEnumerableWeakMap instance.
   * @description Removes all key-value pairs from the SvEnumerableWeakMap instance.
   ...
   */
    ...
    /**
   * Checks if the SvEnumerableWeakMap instance has the specified key.
   * @param {*} k - The key to check.
   * @returns {boolean} - True if the key exists, false otherwise.
   * @description Returns true if the specified key exists in the SvEnumerableWeakMap instance, false otherwise.
   * @category Lookup
   */
    has (k) {
   ...
   * @returns {SvEnumerableWeakMap} - The SvEnumerableWeakMap instance.
   ...
   */
    ...
    /**
   * Removes the specified key from the SvEnumerableWeakMap instance.
   * @param {*} k - The key to remove.
   * @returns {boolean} - True if the key existed and was removed, false otherwise.
   * @description Removes the specified key from the SvEnumerableWeakMap instance and returns a boolean indicating whether the key existed and was removed.
   * @category Modification
   */
    delete (k) {
    ...
    /**
   * Executes the provided function once for each key-value pair in the SvEnumerableWeakMap instance.
   * @param {Function} fn - The function to execute for each key-value pair.
   * @description Executes the provided function once for each key-value pair in the SvEnumerableWeakMap instance. The function is passed the value, key, and the SvEnumerableWeakMap instance itself. Also removes collected keys during iteration.
   * @category Iteration
   */
   ...
   * @description Executes the provided function once for each key in the SvEnumerableWeakMap instance.
   * @category Iteration
   */
    forEachK (fn) { // fn (key)
    ...
    /**
   * Removes collected values from the SvEnumerableWeakMap instance.
   * @description Removes collected values (values that have been garbage collected) from the SvEnumerableWeakMap instance.
   ...
   */
    ...
    /**
   * Returns the number of key-value pairs in the SvEnumerableWeakMap instance.
   * @returns {number} - The number of key-value pairs in the SvEnumerableWeakMap instance.
   * @description Returns the number of key-value pairs in the SvEnumerableWeakMap instance. Note that since WeakRefs are only removed after a collection cycle, the actual size of reachable objects may be lower than this.
   ...
   */
    ...
    /**
   * Returns an array of keys in the SvEnumerableWeakMap instance.
   * @returns {Array} - An array of keys in the SvEnumerableWeakMap instance.
   * @description Returns an array of keys in the SvEnumerableWeakMap instance.
   * @category Information
   */
    keysArray () {
        const keys = [];
