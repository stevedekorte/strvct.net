...
*
* Internally, a SvEnumerableWeakMap of value puuid keys to weakrefs is used so we can
...
SvGlobals.globals().SvEnumerableWeakSet = (class SvEnumerableWeakSet extends Object {
    ...
    */
    constructor () {
        super();
        this._refs = new SvEnumerableWeakMap();
    }
    ...
    */
    ...
    /**
    * @description Adds a value to the SvEnumerableWeakSet.
    * @param {*} v - The value to add.
    * @returns {SvEnumerableWeakSet} This instance.
    ...
    */
    ...
    /**
    * @description Clears all values from the SvEnumerableWeakSet.
    * @category Modification
    */
    clear () {
        this._refs.clear();
    ...
    /**
    * @description Deletes a value from the SvEnumerableWeakSet.
    ...
    */
    ...
    /**
    * @description Checks if the SvEnumerableWeakSet has a given value.
    ...
    */
    ...
    /**
    * @description Returns an array of the values in the SvEnumerableWeakSet.
    ...
    */
    ...
    /**
    * @description Returns the count of values in the SvEnumerableWeakSet.
    ...
    */
    ...
    /**
    * @description Executes a provided function once for each value in the SvEnumerableWeakSet.
    ...
    */
    ...
    /**
    * @description Clears any collected (stale) WeakRefs from the SvEnumerableWeakSet.
    ...
    */
    ...
    /**
    * @description Returns a Set containing all values in the SvEnumerableWeakSet.
    ...
    */
    ...
    /**
    * @description Returns an array containing all values in the SvEnumerableWeakSet.
    ...
    */
    ...
    /**
    * @description Returns an array containing all keys (puuid values) in the SvEnumerableWeakSet.
