...
(class SvStreamNode extends ProtoClass {
    ...
    initPrototypeSlots () {
        ...
        {
            /**
             * @member {SvStreamNode|null} parent
             * @description The parent node of the current node.
             */
            const slot = this.newSlot("parent", null); // SvStreamNode
            slot.setSlotType("SvStreamNode");
...

        {
             ...
             */
            const slot = this.newSlot("children", []); // array of SvStreamNode
     ...
     * @returns {SvStreamNode|null} The ancestor node that satisfies the function, or null if none is found.
     ...
     * @returns {SvStreamNode} The current instance.
     ...
     * @returns {SvStreamNode} The root node of the node tree.
     * @category Tree Traversal
     */
    rootNode () {
        if (this.parent()) {
     ...
     * @returns {SvStreamNode[]} An array of nodes representing the tag path.
     * @category Tree Traversal
     */
    tagPath () {
