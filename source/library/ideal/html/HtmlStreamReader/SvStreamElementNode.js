...
/** * @class SvStreamElementNode
 * @extends SvStreamNode
 * @classdesc SvStreamElementNode represents an HTML element node in a stream of HTML elements.
...
(class SvStreamElementNode extends SvStreamNode {
     ...
     * @returns {SvStreamNode|null} The last text node child, or null if there is none.
     ...
     * @param {SvStreamNode} aNode The node to be added as a child.
     * @returns {SvStreamElementNode} The current node instance.
