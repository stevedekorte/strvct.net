...
/** * @class SvIndexedArray
 * @extends SvHookedArray
...
(class SvIndexedArray extends SvHookedArray {
     ...
     * @returns {SvIndexedArray} - Returns this for chaining
    ...
    /**
     * Run self-test for SvIndexedArray
     * @returns {SvIndexedArray} - Returns this for chaining
     * @category Testing
     */
    static selfTest () {
        let ia = SvIndexedArray.clone();
