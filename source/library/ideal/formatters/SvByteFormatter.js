...
/** * @class SvByteFormatter
 * @extends ProtoClass
 * @classdesc SvByteFormatter takes a number of bytes and returns a string with the order of magnitude in
 * standard SI decimal digital information format.
 * Example:
 * const stringVersion = SvByteFormatter.clone().setValue(aNumberOfBytes).formattedValue()
 *
 * // Output examples:
