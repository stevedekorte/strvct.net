...
/** * @class SvHttpResponseCodes
 * @extends ProtoClass
 * @classdesc The SvHttpResponseCodes class provides a convenient way to retrieve information about HTTP response codes.
...
(class SvHttpResponseCodes extends ProtoClass {
    /**
