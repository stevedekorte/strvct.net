 ...
 * Example use:
 *
 *      const search = new SvNamespaceSearch()
 ...
 */
(class SvNamespaceSearch extends ProtoClass {
    ...
    /**
     * @description Initializes the SvNamespaceSearch instance.
     ...
     * @returns {SvNamespaceSearch} The current instance for chaining.
     * @category Search
     */
    find (searchString) {
        this.clear();
    ...
    /**
     * @description Performs a self-test of the SvNamespaceSearch class.
     * @static
     * @category Testing
     */
    static selfTest () {
        const ns = SvNamespaceSearch.clone();
