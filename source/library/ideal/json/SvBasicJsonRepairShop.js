...
class SvBasicJsonRepairShop extends Object {
    /**
   * Constructor
   ...
   */
    ...
    logAttemptingToFix () {
        console.warn("SvBasicJsonRepairShop attempting to fix:");
        this.logJsonString();
    }

    logSuccessfullyRepaired () {
        console.log("SvBasicJsonRepairShop successful. Fixes: " + this.fixNote() + ":");
        this.logJsonString();
    }

    logFailedToRepair () {
        console.error("SvBasicJsonRepairShop failed to repair:");
        this.logJsonString();
    }
...
SvGlobals.globals().SvBasicJsonRepairShop = SvBasicJsonRepairShop;
