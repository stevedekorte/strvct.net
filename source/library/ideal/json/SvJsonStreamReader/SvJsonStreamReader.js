...
/** * @module library.ideal.json.SvJsonStreamReader
 */

/** * @class SvJsonStreamReader
 * @extends ProtoClass
...
(class SvJsonStreamReader extends ProtoClass {
   ...
   * @returns {SvJsonStreamReader} The instance of SvJsonStreamReader.
   * @category Stream Control
   */
    onStreamJson (data) {
    ...
    /**
   * @description Shuts down the SvJsonStreamReader.
   * @returns {SvJsonStreamReader} The instance of SvJsonStreamReader.
   * @category Lifecycle
   */
    shutdown () {
   ...
   */
    pushKey (key) {
        assert(Type.isString(key), " SvJsonStreamReader: json key value of '" + key + "' must be a string not a " + Type.typeName(key));
