...
class SvMarkdownToc extends Object {
    constructor () {
        super();
     ...
     * @returns {SvMarkdownToc} The SvMarkdownToc instance, allowing for method chaining.
     */
...
SvGlobals.globals().SvMarkdownToc = SvMarkdownToc;
