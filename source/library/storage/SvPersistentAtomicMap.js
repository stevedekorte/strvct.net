...
/**
 * @class SvPersistentAtomicMap
 * @extends ideal.SvAtomicMap
 ...
 */
(class SvPersistentAtomicMap extends ideal.SvAtomicMap {
    /**
    ...
    init () {
        ...
        this.setName("SvPersistentAtomicMap");
    }
     ...
     * @returns {SvPersistentAtomicMap} - Returns this instance.
