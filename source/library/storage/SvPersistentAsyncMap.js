 ...
 *
 * @class SvPersistentAsyncMap
 * @extends ProtoClass
 * @classdesc Provides a persistent asynchronous map implementation using IndexedDB.
 */
(class SvPersistentAsyncMap extends ProtoClass {

    /**
     * Initialize prototype slots for the SvPersistentAsyncMap.
     * @returns {undefined}
     */
    initPrototypeSlots () {
        /**
    ...
    /**
     * Initialize the SvPersistentAsyncMap instance.
     * @returns {undefined}
     ...
     * @returns {SvPersistentAsyncMap} The instance for method chaining.
     * @category Operations
     */
    close () {
        if (this.isOpen()) {
