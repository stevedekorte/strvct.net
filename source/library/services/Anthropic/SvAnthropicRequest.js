 ...
 */
(class SvAnthropicRequest extends SvAiRequest {
    ...
    /**
   * @description Initializes the SvAnthropicRequest instance.
   ...
   * @returns {SvAnthropicRequest} The current instance.
   * @category Request Preparation
   */
    setupForStreaming () {
    ...
    onStreamJsonChunk (json) {
        ...
        if (json.type === "error") {
            ...
            if (json.error.type === "overloaded_error") {
                errorClass = SvAiRequestOverloadedError;
            }
