...
/**
 * @class SvAzureService
 * @extends SvStorableNode
 * @classdesc SvAzureService for text-to-speech functionality
 */
(class SvAzureService extends SvStorableNode {
    /**
   * @description Initializes the prototype slots for the SvAzureService
   ...
   */
     ...
     */
        ...
        /**
     * @member {SvAzureSpeakers} speakers - Speakers for Azure service
     * @category Text-to-Speech
     */
        {
            const slot = this.newSlot("speakers", null);
            slot.setLabel("speakers");
            slot.setFinalInitProto(SvAzureSpeakers);
            slot.setShouldStoreSlot(true);
            slot.setIsSubnode(true);
        }

        /**
     * @member {SvAzureVoices} voices - Voices for Azure service
     * @category Text-to-Speech
     */
        {
            const slot = this.newSlot("voices", null);
            slot.setLabel("voices");
            slot.setFinalInitProto(SvAzureVoices);
    ...
    /**
   * @description Initializes the SvAzureService
   * @category Initialization
   */
    init () {
        super.init();
