 ...
 */
(class SvAzureSpeaker extends SvSummaryNode {
    /**
   * Initializes the prototype slots for the SvAzureSpeaker class.
     ...
     */
        {
            ...
            slot.setFinalInitProto(SvAzureTtsRequests);
            slot.setShouldStoreSlot(true);
  ...
  */
    ...
    /**
   * Initializes the SvAzureSpeaker instance.
   * @category Initialization
   */
    init () {
        super.init();
    ...
    /**
   * Performs final initialization of the SvAzureSpeaker instance.
   * @category Initialization
   */
    finalInit () {
        super.finalInit();
   ...
   * @returns {Object} The SvAzureSpeaker instance.
   */
    setIsMuted (aBool) {
