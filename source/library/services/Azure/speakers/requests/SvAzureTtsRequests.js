...
(class SvAzureTtsRequests extends SvSummaryNode {
    ...
    /**
      ...
      * @description Sets up the initial state of the SvAzureTtsRequests instance.
      * @category Initialization
      */
    init () {
        super.init();
        ...
        this.setSubnodeClasses([SvAzureTtsRequest]);
