...
/**
 * @class SvAzureTtsRequest
 * @extends SvStorableNode
 * @classdesc Represents a Text-to-Speech request for Azure TTS service.
 */
(class SvAzureTtsRequest extends SvStorableNode {
    /**
   * Initializes the prototype slots for the SvAzureTtsRequest class.
   ...
   */
    ...
    /**
   * Initializes the prototype of the SvAzureTtsRequest class.
   * @category Initialization
   */
    initPrototype () {
    ...
    /**
   * Initializes the SvAzureTtsRequest instance.
   * @category Initialization
   */
    init () {
        super.init();
    ...
    /**
   * Performs final initialization of the SvAzureTtsRequest instance.
   * @category Initialization
   */
    finalInit () {
        super.finalInit();
   ...
   */
    async start () {
        ...
        if (!response.ok) {
            const codeString = SvHttpResponseCodes.shared().shortStringForCode(response.status);
   ...
   * @returns {SvAzureTtsRequest} The current instance.
   * @category UI
   */
