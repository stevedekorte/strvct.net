 ...
 */
(class SvAzureVoice extends SvSummaryNode {
   ...
   */
    ...
    /**
   * @description Initializes prototype slots for the SvAzureVoice class.
   ...
   */
    ...
    /**
   * @description Initializes the SvAzureVoice instance.
   * @category Initialization
   */
    init () {
        super.init();
   ...
   * @returns {SvAzureVoice} The current instance
   * @category Data
   */
    setJson (json) {
        this._json = json;
