...
(class SvAzureVoices extends SvSummaryNode {
   ...
   */
    setupSubnodes () {
        ...
        this.voicesJson().forEach(entry => {
            const voice = SvAzureVoice.clone().setJson(entry);
  ...
  setupLocales () {
    ...
    localesMap.forEachKV((localeName, voices) => {
      const locale = SvAzureLocale.clone().setTitle(localeName).setSubnodes(voices)
