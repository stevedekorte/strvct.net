...
/**
 * @class SvConversationMessage
 * @extends SvTextAreaField
 * @classdesc Represents a message in a conversation.
 */
(class SvConversationMessage extends SvTextAreaField {

    /**
   * Initialize prototype slots for the SvConversationMessage class.
   ...
   */
     ...
     */
        ...
        /**
     * @member {SvConversation} conversation - The conversation this message belongs to.
    ...
    /**
   * Initialize the prototype of the SvConversationMessage class.
   */
    initPrototype () {
    ...
    /**
   * Perform final initialization of the SvConversationMessage instance.
   */
    finalInit () {
        super.finalInit();
   ...
   * @returns {SvConversationMessage|null} The message being replied to, or null if none.
   * @category Relationship
   */
    inReplyToMessage () {
   ...
   * @returns {SvConversationMessage} The SvConversationMessage instance.
   * @category Data
   */
    setValue (s) {
   ...
   * @returns {SvConversationMessage|null} The previous message or null if none.
   * @category Relationship
   */
    previousMessage () {
