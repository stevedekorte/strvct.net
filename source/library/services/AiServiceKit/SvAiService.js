 ...
 *;
 */
(class SvAiService extends SvSummaryNode {
   ...
   */
    ...
    /**
   * @description Initializes the prototype slots for the SvAiService.
   ...
   */
     ...
     */
        ...
        /**
     * @member {SvAiChatModels} models - The AI chat models.
     * @category Models
     */
        {
            const slot = this.newSlot("models", null);
            slot.setFinalInitProto(SvAiChatModels);
            slot.setShouldStoreSlot(true);
            slot.setIsSubnode(true);
        }

        /**
     * @member {SvAiConversations} conversations - The AI conversations.
     * @category Conversations
     */
        {
            const slot = this.newSlot("conversations", null);
            slot.setFinalInitProto(SvAiConversations);
            slot.setShouldStoreSlot(true);
            slot.setIsSubnode(true);
        }
    ...
    /**
   * @description Performs final initialization of the SvAiService.
   * @category Initialization
   */
    finalInit () {
        super.finalInit();
   ...
   * @returns {SvAiChatModel} The default assistant chat model.
   * @category Models
   */
    assistantChatModel () {
   ...
   * @returns {SvAiService} The SvAiService instance.
   ...
   */
    setModelsJson (json) {
        ...
        json.forEach(modelInfo => {
            const model = SvAiChatModel.clone().setJson(modelInfo).setService(this);
