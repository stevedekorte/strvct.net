...
(class SvAiMessage extends SvConversationMessage {
   ...
   */
    ...
    */
    ...
    /**
   * @description Initializes the prototype slots for the SvAiMessage class.
   ...
   */
    ...
    /**
   * @description Initializes the SvAiMessage instance.
   * @category Initialization
   */
    init () {
        super.init();
   ...
   * @returns {boolean} Always returns false for SvAiMessage.
   * @category Message Properties
   */
    isResponse () {
        return false;
   ...
   */
    isVisible () {
        // NOTE: this is the real place to hide the tool call results from non-dev users
   ...
   * @returns {SvAiMessage} This instance for chaining.
   * @category Message Properties
   */
    setContent (s) {
        this.setValue(s);
   ...
   */
    cleanupAssistantMessage () {
        if (this.svType() === "SvAiResponseMessage") {
