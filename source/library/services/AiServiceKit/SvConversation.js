...
(class SvConversation extends SvJsonArrayNode {
    /**
   * @description Initializes the prototype slots for the SvConversation class.
   ...
   */
    initPrototypeSlots () {

        {
            ...
            slot.setSlotType("SvChatInputNode");
    ...
    /**
   * @description Initializes the prototype properties for the SvConversation class.
   * @category Initialization
   */
    initPrototype () {
    ...
    /**
   * @description Initializes a new SvConversation instance.
   * @category Initialization
   */
    init () {
        super.init();
  ...
  */
   ...
   * @returns {SvConversation} The conversation instance.
   ...
   */
    ...
    newMessageFromJson (msgJson) {
        const msg = SvConversationMessage.fromJsonArchive(msgJson);
   ...
   */
    ...
    updateMessageJson (msgJson) {
        ...
        if (oldMsg) {
            ...
            SvSimpleSynth.clone().playReceiveBeep();
