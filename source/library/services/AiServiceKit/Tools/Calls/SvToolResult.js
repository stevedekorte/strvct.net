...
(class SvToolResult extends SvSummaryNode {
   ...
   */
    initPrototypeSlots () {

        {
            ...
            slot.setSlotType("SvToolCall");
            slot.setShouldJsonArchive(false);
            slot.setIsInJsonSchema(false);
            slot.setShouldStoreSlot(true);
        }

        // ---- BEGIN SvToolResult JSON schema ----
    ...
    */
    ...
    /**
     * @description Serializes this SvToolResult to JSON for cloud sync.
    ...
    /**
     * @description Deserializes JSON data into this SvToolResult.
