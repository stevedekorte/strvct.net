...
* - - - request, response
*/
(class SvAiConversations extends SvSummaryNode {
    /**
    ...
    */
    ...
    /**
    * @description Initializes the SvAiConversations instance.
    * @category Initialization
    */
    init () {
        super.init();
    ...
    */
    finalInit () {
        ...
        this.setSubnodeClasses([SvAiConversation]);
    }
