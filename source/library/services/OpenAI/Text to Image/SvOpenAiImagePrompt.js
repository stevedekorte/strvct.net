...
(class SvOpenAiImagePrompt extends SvSummaryNode {
     ...
     */
        ...
        /**
     * @member {SvOpenAiImages} images
     * @description The generated images.
     * @category Output
     */
        {
            const slot = this.newSlot("images", null);
            slot.setFinalInitProto(SvOpenAiImages);
            slot.setShouldStoreSlot(true);
            slot.setIsSubnode(true);
            slot.setSlotType("SvOpenAiImages");
        }
