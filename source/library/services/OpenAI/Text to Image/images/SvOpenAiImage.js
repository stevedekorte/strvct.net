 ...
 */
(class SvOpenAiImage extends SvSummaryNode {
    /**
   * @description Initializes the prototype slots for the SvOpenAiImage class.
   */
    initPrototypeSlots () {
  ...
  async fetch () {
    ...
    const apiKey = await SvOpenAiService.shared().apiKeyOrUserAuthToken();
