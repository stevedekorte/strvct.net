...
/**
* @class SvOpenAiImages
* @extends SvSummaryNode
* @classdesc Represents a collection of OpenAI generated images.
*/
(class SvOpenAiImages extends SvSummaryNode {

    /**
    * @description Initializes the prototype slots for the SvOpenAiImages class.
    ...
    */
    initPrototypeSlots () {
        ...
        this.setSubnodeClasses([SvOpenAiImage]);
