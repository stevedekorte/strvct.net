...
/**
 * @class SvOpenAiTtsSession
 * @extends SvSummaryNode
 * @classdesc SvOpenAiTtsSession manages Text to Speech operations.
 */
(class SvOpenAiTtsSession extends SvSummaryNode {
   ...
   */
    ...
    */
    ...
    /**
   * @description Initializes the SvOpenAiTtsSession.
   * @returns {SvOpenAiTtsSession} The initialized instance.
   */
    init () {
        super.init();
  ...
  */
   ...
   * @returns {SvOpenAiService} The OpenAI service instance.
   */
    service () {
   ...
   * @returns {SvOpenAiTtsSession} The current instance.
   */
    setIsMuted (aBool) {
   ...
   * @param {SvOpenAiTtsRequest} request - The request that began.
   */
   ...
   * @param {SvOpenAiTtsRequest} request - The completed request.
   */
   ...
   * @param {SvOpenAiTtsRequest} request - The request that errored.
