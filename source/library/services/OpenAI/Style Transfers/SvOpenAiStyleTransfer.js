...
(class SvOpenAiStyleTransfer extends SvSummaryNode {

    /**
     * @description Initializes the prototype slots for the SvOpenAiStyleTransfer class.
     */
    initPrototypeSlots () {
    ...
    async generateWithStyleReference (prompt, styleImageUrl, styleImageDataUrl) {
        try {
            ...
            const uploadProxyEndpoint = SvProxyServers.shared().defaultServer().proxyUrlForUrl(uploadEndpoint);
            ...
            const generationProxyEndpoint = SvProxyServers.shared().defaultServer().proxyUrlForUrl(generationEndpoint);
