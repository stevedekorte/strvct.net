...
/**
 * @class SvYouTubeAudioPlayer
 * @extends SvStorableNode
 * @classdesc SvYouTubeAudioPlayer
 *
 ...
 */
(class SvYouTubeAudioPlayer extends SvStorableNode {

    /**
   * @description Initializes the prototype slots for the SvYouTubeAudioPlayer.
   */
    initPrototypeSlots () {
    ...
    /**
   * @description Initializes the SvYouTubeAudioPlayer.
   */
    init () {
        super.init();
   ...
   */
    ...
    /**
   * @description Performs final initialization of the SvYouTubeAudioPlayer.
   */
    finalInit () {
        this.setShouldStore(true);
        this.setShouldStoreSubnodes(false);
   ...
   */
    async setupFrame () {
        ...
        await SvYouTubePlayerFrame.shared().frameReadyPromise();
        this.setupPlayer();
    }

    /**
   * @description Sets up the YouTube player.
   * @returns {SvYouTubeAudioPlayer} The player instance.
   */
    setupPlayer () {
   ...
   * @returns {Promise<SvYouTubeAudioPlayer>} A promise that resolves with the player instance.
   */
