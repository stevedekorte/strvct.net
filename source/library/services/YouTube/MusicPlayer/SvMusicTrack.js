 ...
 */
(class SvMusicTrack extends SvSummaryNode {

    /**
   * Initializes the prototype slots for the SvMusicTrack class.
   ...
   */
    ...
    /**
   * Initializes the SvMusicTrack instance.
   * @category Initialization
   */
    init () {
        super.init();
    ...
    /**
   * Performs final initialization of the SvMusicTrack instance.
   * @category Initialization
   */
    finalInit () {
        this.setShouldStore(true);
   ...
   * @category Hierarchy
   * @returns {SvMusicLibrary} The parent music library.
   */
    library () {
        return this.firstParentChainNodeOfClass(SvMusicLibrary);
    }

    /**
   * Returns the parent folder of this track.
   * @category Hierarchy
   * @returns {SvMusicFolder} The parent music folder.
   */
    folder () {
        return this.firstParentChainNodeOfClass(SvMusicFolder);
    }
   ...
   * @category Playback
   * @returns {SvMusicTrack} This instance.
   */
    togglePlay () {
        if (this.isPlaying()) {
            this.stop();
