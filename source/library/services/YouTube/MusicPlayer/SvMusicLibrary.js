...
(class SvMusicLibrary extends SvSummaryNode {
     ...
     */
        {
            ...
            slot.setSyncsToView(true);
            slot.setDuplicateOp("duplicate");
            slot.setFinalInitProto(SvMusicFolder);
            slot.setIsSubnode(true);
            slot.setSlotType("SvMusicFolder");

        }

        /**
     * @member {SvYouTubeAudioPlayer} musicPlayer
     ...
     */
        ...
        /**
     * @member {SvYouTubeAudioPlayer} soundEffectPlayer
     ...
     */
        ...
        this.setSubnodeClasses([SvMusicFolder]);
   ...
   * @returns {SvMusicLibrary} The music library.
   */
    setupPlaylists () {
        ...
        playlistNames.forEach((name) => {
            const playlist = SvMusicFolder.clone();
   ...
   * @returns {SvYouTubeAudioPlayer} The music player.
   */
    musicPlayer () {
        if (!this._musicPlayer) {
            const p = SvYouTubeAudioPlayer.clone();
   ...
   * @returns {SvYouTubeAudioPlayer} The sound effect player.
   */
    soundEffectPlayer () {
   ...
   * @returns {SvMusicFolder} The playlist.
   */
   ...
   * @returns {SvMusicTrack} The track.
   */
    trackWithName (name) {
