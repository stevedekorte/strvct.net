...
/**
 * @class SvFirestoreDocument
 * @extends SvFirestoreNode
 * @classdesc Represents a Document stored in Firestore Database.
 *
 */
(class SvFirestoreDocument extends SvFirestoreNode {
    ...
    initPrototypeSlots () {
        ...
        // Subcollections container
        {
            ...
            slot.setFinalInitProto("SvFirestoreCollections");
    ...
    setContentString (value) {
        try {
            ...
            console.error("SvFirestoreDocument.setContentString: Error parsing JSON:", e);
        }
        return this;
    }
    ...
    async asyncUpload () {
        try {
            ...
            console.error("SvFirestoreDocument.asyncUpload failed:", error);
    ...
    async asyncDelete () {
        try {
            ...
            console.error("SvFirestoreDocument.asyncDelete failed:", error);
            this.setError(error.message || String(error));
    ...
    async asyncDownload () {
        try {
            ...
            try {
                ...
                console.error("SvFirestoreDocument.asyncDownload: Error stringifying data:", e);
            ...
            console.error("SvFirestoreDocument.asyncDownload failed:", error);
            this.setError(error.message || String(error));
     ...
     * @returns {SvFirestoreCollection|null} The found subcollection or null
     * @category Query
     */
     ...
     * @returns {SvFirestoreCollection} The found or created subcollection
     * @category Helper
     */
    ...
    async asyncMigrate () {
        ...
        try {
            ...
            console.error("SvFirestoreDocument.asyncMigrate failed:", error);
            this.setError(error.message || String(error));
