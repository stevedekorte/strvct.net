 ...
 * Contains a SvFirestoreDocuments instance that holds the query results.
 */
(class SvFirestoreQuery extends SvSummaryNode {
    ...
    async asyncExecute () {
        ...
        if (!parent || !parent.isKindOf(SvFirestoreCollection)) {
            throw new Error("SvFirestoreQuery must have a SvFirestoreCollection owner");
        }
