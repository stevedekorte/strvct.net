...
/**
 * @class SvFirestoreCollections
 * @extends SvSummaryNode
 * @classdesc Collection of Firestore collections for testing and management
 *
 */
(class SvFirestoreCollections extends SvSummaryNode {
    ...
    initPrototype () {
        ...
        this.setSubnodeClasses([SvFirestoreCollection]);
     ...
     * @returns {SvFirestoreCollection} The new collection
     * @category Actions
     */
    addTestCollection () {
     ...
     * @returns {Array<SvFirestoreCollection>} Array of collections
     * @category Query
     */
    collections () {
     ...
     * @returns {SvFirestoreCollection|null} The found collection or null
     * @category Query
     */
     ...
     * @returns {SvFirestoreCollection} The found or created collection
     * @category Helper
     */
    collectionNamedCreateIfAbsent (name) {
        ...
        if (parentDoc && parentDoc.isKindOf(SvFirestoreDocument)) {
        ...
        if (!col) {
            col = SvFirestoreCollection.clone();
