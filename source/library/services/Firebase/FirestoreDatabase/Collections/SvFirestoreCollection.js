 ...
 * SvFirestoreDocument instances representing the documents in the collection.
 *
 ...
 */
(class SvFirestoreCollection extends SvFirestoreNode {
    ...
    initPrototypeSlots () {
        ...
        // Documents container (simple view of all documents)
        {
            ...
            slot.setFinalInitProto(SvFirestoreDocuments);
            slot.setIsSubnodeField(true);
            slot.setShouldStoreSlot(true);
            slot.setSyncsToView(true);
            slot.setSlotType("SvFirestoreDocuments");
        }

        // Query (for searches with limit, orderBy, filtering, pagination)
        {
            const slot = this.newSlot("query", null);
            slot.setFinalInitProto(SvFirestoreQuery);
            slot.setIsSubnodeField(true);
            slot.setShouldStoreSlot(true);
            slot.setSyncsToView(true);
            slot.setSlotType("SvFirestoreQuery");
        }
     ...
     * @returns {SvFirestoreDocument|null} The found document or null
     * @category Query
     */
     ...
     * @returns {SvFirestoreDocument} The found or created document
     * @category Helper
     */
     ...
     * @returns {SvFirestoreDocument} The new document
     * @category Actions
     */
    addDocument () {
    ...
    async asyncMigrate () {
        ...
        try {
            ...
            console.error("SvFirestoreCollection.asyncMigrate failed:", error);
            this.setError(error.message || String(error));
            throw error;
        }
    }
