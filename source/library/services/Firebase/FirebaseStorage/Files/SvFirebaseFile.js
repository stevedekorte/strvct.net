 ...
 */
(class SvFirebaseFile extends SvFirebaseNode {
     ...
     * @returns {Promise<SvFirebaseFile>} This instance for chaining
     * @category Helper
     */
     ...
     */
    humanReadableSize () {
        return SvNumberFormatter.clone().setValue(this.size()).setSignificantDigits(2).formattedValue();
    }
