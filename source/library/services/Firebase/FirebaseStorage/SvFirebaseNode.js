 ...
 */
(class SvFirebaseNode extends SvSummaryNode {
     ...
     * @returns {SvFirebaseFolder|null} The parent folder or null if at root
     * @category Hierarchy
     */
    parentFolder () {
        const p = this.parentNode();
        if (p && p.isKindOf(SvFirebaseFolder)) {
            return p;
        }
        return null;
    }
    ...
    calcFullPathThroughParent () {
        ...
        while (current) {
            ...
            if (current.isKindOf(SvFirebaseFolder)) {
