...
/**
 * @class SvFirebaseRootFolder
 * @extends SvFirebaseFolder
 * @classdesc Represents the root of Firebase Storage bucket
 *
 * This class extends SvFirebaseFolder to provide the top-level entry point
 ...
 */
(class SvFirebaseRootFolder extends SvFirebaseFolder {
     ...
     * @returns {SvFirebaseFolder} The user's folder
     * @category Helper
     */
