...
(class SvHomeAssistantDevice extends SvHomeAssistantObject {
    /**
    ...
    */
    ...
    /**
    * @description Initializes the SvHomeAssistantDevice.
    * @category Initialization
    */
    init () {
        super.init();
    ...
    * @returns {SvHomeAssistantDevice} The current device instance.
