...
/**
 * @class SvGeminiService
 * @extends SvAiService
 * @classdesc SvGeminiService manages classes related to the Google Gemini and Vertex AI APIs.
 *
 */

(class SvGeminiService extends SvAiService {
   ...
   */
     ...
     */
...

        {
            ...
            slot.setFinalInitProto(SvGeminiVideoPrompts);
...

        {
            ...
            slot.setFinalInitProto(SvGeminiImageUpscalings);
            slot.setIsSubnodeField(true);
            slot.setShouldStoreSlot(true);
        }
