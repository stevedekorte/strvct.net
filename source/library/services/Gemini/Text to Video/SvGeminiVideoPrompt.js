...
(class SvGeminiVideoPrompt extends SvSummaryNode {
    ...
    apiUrl () {
        if (!this.projectId()) {
            ...
            this.setError("No project ID available. Please check SvGeminiService configuration.");
            return null;
        }
    ...
    async startGeneration () {
        ...
        try {
            ...
            this.setError(errorMessage);
            this.sendDelegateMessage("onVideoPromptError", [this]);
            console.error("SvGeminiVideoPrompt generation error:", error);
            return null;
        }
    }
    ...
    async checkOperationStatus () {
        ...
        const proxyApiUrl = SvProxyServers.shared().defaultServer().proxyUrlForUrl(apiUrl);
        ...
        try {
            ...
            console.log("SvGeminiVideoPrompt: checking operation status at:\n[", proxyApiUrl, "]\nwith options: ", JSON.stringify(options, null, 2));
            ...
            if (data.done) {
                ...
                */
                ...
                console.log("SvGeminiVideoPrompt: video data url:" + dataUrl.length + " bytes");
            ...
            this.setError(errorMessage);
            this.sendDelegateMessage("onVideoPromptError", [this]);
            console.error("SvGeminiVideoPrompt operation status error:", error);
            return false;
        }
    }
