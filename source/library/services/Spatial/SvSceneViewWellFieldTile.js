...
/**
 * @class SvSceneViewWellFieldTile
 * @extends SvFieldTile
 * @classdesc SvSceneViewWellFieldTile class for handling scene view well fields.
 */
(class SvSceneViewWellFieldTile extends SvFieldTile {
    ...
    initPrototypeSlots () {
        {
             ...
             * @category View
             */
            const slot = this.newSlot("dataViewClass", SvSceneView);
            slot.setSlotType("Class");
        }
    }

    /**
     * @description Initializes the SvSceneViewWellFieldTile instance.
     * @returns {SvSceneViewWellFieldTile} The initialized instance.
     * @category Initialization
     */
    init () {
        super.init();
    ...
    /**
     * @description Creates the value view for the SvSceneViewWellFieldTile.
    ...
    /**
     * @description Synchronizes the SvSceneViewWellFieldTile with its node.
     * @returns {SvSceneViewWellFieldTile} The synchronized instance.
    ...
    /**
     * @description Synchronizes the SvSceneViewWellFieldTile to its node.
     * @returns {SvSceneViewWellFieldTile} The synchronized instance.
     * @category Synchronization
     */
    syncToNode () {
    ...
    /**
     * @description Checks if the SvSceneViewWellFieldTile is empty.
