 ...
 */
(class SvSceneView extends SvNodeView {
    ...
    initPrototypeSlots () {
        ...
        /**
         * @member {SvDomView} closeButtonView - Close button view
         */
        {
    ...
    /**
     * @description Initializes the SvSceneView
     * @returns {SvSceneView} The initialized SvSceneView instance
     */
    init () {
        super.init();
     ...
     * @returns {SvSceneView} The SvSceneView instance
     */
    setIsEditable (aBool) {
