...
/**
 * @class SvRzSigServerPeers
 * @extends SvSummaryNode
 * @classdesc Represents a collection of SvRzSigServer peers.
 */
(class SvRzSigServerPeers extends SvSummaryNode {

    /**
   * Initializes the prototype slots for the SvRzSigServerPeers class.
   ...
   * @returns {SvRzSigServerPeers} The updated SvRzSigServerPeers instance.
   */
    ...
    */
        ...
        peerIds.forEach(peerId => {
            const rzPeer = SvRzPeer.clone().setPeerId(peerId);
