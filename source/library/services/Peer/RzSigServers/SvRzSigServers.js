...
/**
 * @class SvRzSigServers
 * @extends SvSummaryNode
 * @classdesc SvRzSigServers manages a collection of PeerJS Signalling Servers.
 */
(class SvRzSigServers extends SvSummaryNode {
    /**
   * @description Initializes the prototype slots for the SvRzSigServers class.
   * @category Initialization
   */
    initPrototypeSlots () {
        this.setSubnodeClasses([SvRzSigServer]);
   ...
   */
    setupDefaultServers () {
        ...
        this.defaultServerDicts().forEach(dict => {
            ...
            if (!server) {
                const newServer = SvRzSigServer.clone().setDict(dict);
   ...
   * @returns {Array} An array of SvRzSigServer objects.
   * @category Server Management
   */
    servers () {
