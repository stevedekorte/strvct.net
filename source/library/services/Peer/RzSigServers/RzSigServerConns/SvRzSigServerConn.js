...
/**
 * @module library.services.Peer.SvRzSigServers.SvRzSigServerConns
 */

/**
 * @class SvRzSigServerConn
 * @extends SvStorableNode
 * @classdesc Wrapper for PeerJS Peer object.
 */
(class SvRzSigServerConn extends SvStorableNode {
    /**
   * @description Initializes the prototype slots for the SvRzSigServerConn class.
   ...
   */
     ...
     */
        ...
        /**
     * @member {SvRzPeerConns} peerConns
     */
        {
            const slot = this.newSlot("peerConns", null);
            slot.setFinalInitProto(SvRzPeerConns);
            slot.setShouldStoreSlot(true);
            slot.setIsSubnode(true);
            slot.setSlotType("SvRzPeerConns");
        }
    ...
    /**
   * @description Initializes the SvRzSigServerConn instance.

   * @returns {SvRzSigServerConn}
   */
    init () {
        super.init();
    ...
    /**
   * @description Performs final initialization of the SvRzSigServerConn instance.
   ...
   */
    ...
    /**
   * @description Gets the title of the SvRzSigServerConn instance.
   ...
   */
    ...
    /**
   * @description Gets the subtitle of the SvRzSigServerConn instance.
   ...
   */
    ...
    /**
   * @description Checks if the SvRzSigServerConn is connected.
   ...
   */
    ...
    /**
   * @description Shuts down the SvRzSigServerConn.
   ...
   */
    ...
    /**
   * @description Disconnects the SvRzSigServerConn.
   ...
   */
    ...
    /**
   * @description Destroys the SvRzSigServerConn.
  ...
  */
   ...
   * @returns {SvRzSigServerConn} The current instance.
   */
    setPeer (aPeer) {
        this._peer = aPeer;
        return this;
   ...
   */
    newPeerId () {
        return this.peerIdPrefix() + "-" + SvRzSigServer.generateRandomPeerId(10);
    }
   ...
   * @param {SvRzPeerConn} aPeerConn - The peer connection to add.
   * @returns {SvRzSigServerConn} The current instance.
   */
   ...
   * @param {SvRzPeerConn} peerConn - The peer connection object.
   * @returns {SvRzSigServerConn} The current instance.
   */
   ...
   * @param {string} peerId - The peer ID.
   * @returns {SvRzPeerConn} The peer connection object.
   */
   ...
   */
    ...
    const newSubnodes = newPeerIds.map(id => {
      ...
      if (!pc) {
        pc = SvRzPeerConn.clone().setPeerId(id).setSigServerConn(this)
      }
      return pc
    })
