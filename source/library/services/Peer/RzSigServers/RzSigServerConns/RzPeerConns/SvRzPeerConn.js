/**
 * @module library.services.Peer.SvRzSigServers.SvRzSigServerConns.SvRzPeerConns
 */
 ...
 */
(class SvRzPeerConn extends SvSummaryNode {
   ...
   */
    ...
    /**
   * @description Initializes the prototype slots for the SvRzPeerConn class.
   */
    initPrototypeSlots () {
        {
            /**
       ...
       */
        ...
        {
            /**
       * @member {SvRzMsgs} peerMsgs
       */
            const slot = this.newSlot("peerMsgs", null);
            slot.setFinalInitProto(SvRzMsgs);
            slot.setShouldStoreSlot(true);
            slot.setIsSubnode(true);
            slot.setSlotType("SvRzMsgs");
        }
       ...
       */
        ...
        {
            /**
       * @member {SvRzSigServerConn} sigServerConn
       */
            const slot = this.newSlot("sigServerConn", null);
            slot.setSlotType("SvRzSigServerConn");
        }
   ...
   */
    ...
    /**
   * @description Initializes the SvRzPeerConn instance.
   * @returns {SvRzPeerConn} The initialized instance.
   */
    init () {
        super.init();
   ...
   * @returns {SvRzPeerConn} The current instance.
   */
    setConn (conn) {
        this._conn = conn;
        if (conn) {
   ...
   */
    onData (json) { // we set connection transmission format to JSON
        if (this.useMessageLog()) {
            const msg = SvRzMsg.clone().setContent(json);
