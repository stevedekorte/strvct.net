 ...
 * @classdesc Represents a message in the SvRzMsg system.
 */
(class SvRzMsg extends SvSummaryNode {
    ...
    /**
   * @description Initializes the SvRzMsg instance.
   * @returns {SvRzMsg} The initialized SvRzMsg instance.
