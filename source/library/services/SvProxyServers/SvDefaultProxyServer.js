...
/**
 * @class SvDefaultProxyServer
 * @extends SvProxyServer
 * @classdesc SvProxyServer implementation for default proxy settings.
 *
 *
 */
(class SvDefaultProxyServer extends SvProxyServer {
   ...
   */
    setupForPage () {
        ...
        // Example: SvProxyServers.shared().defaultServer().setupForConfigDict(appProxyConfigDict);
    }
