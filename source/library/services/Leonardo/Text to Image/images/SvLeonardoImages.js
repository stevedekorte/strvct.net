...
/**
* @class SvLeonardoImages
* @extends SvSummaryNode
* @classdesc Represents a collection of Leonardo generated images.
*/
(class SvLeonardoImages extends SvSummaryNode {

    /**
    * @description Initializes the prototype slots for the SvLeonardoImages class.
    ...
    */
    initPrototypeSlots () {
        ...
        this.setSubnodeClasses([SvLeonardoImage]);
    ...
    /**
    * @description Returns the subtitle for the SvOpenAiImages instance.
    * @returns {string} The status of the SvOpenAiImages instance.
    * @category Display
    */
    subtitle () {
        return this.status();
    ...
    /**
    * @description Determines and returns the current status of the SvOpenAiImages instance.
