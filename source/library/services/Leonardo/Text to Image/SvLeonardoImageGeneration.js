...
/**
 * @class SvLeonardoImageGeneration
 * @extends SvSummaryNode
 * @classdesc Polls for the status of an image generation request.
 *
 * The SvLeonardoImagePrompt node creates a SvLeonardoImageGeneration node with the generation id
 * and polls for the status of the generation.
 *
 * When the generation is complete, the SvLeonardoImagePrompt node creates SvLeonardoImage nodes
 * and sets their urls.
 *
 ...
 *
  ...
  */
(class SvLeonardoImageGeneration extends SvSummaryNode {
   ...
   */
     ...
     */
        ...
        /**
     * @member {SvLeonardoImages} images
     * @description The generated images.
     * @category Output
     */
        {
            const slot = this.newSlot("images", null);
            slot.setFinalInitProto(SvLeonardoImages);
            slot.setShouldStoreSlot(true);
            slot.setIsSubnode(true);
            slot.setSlotType("SvLeonardoImages");
        }
