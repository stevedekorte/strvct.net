...
/**
 * @class SvSpeechToTextSession
 * @extends SvSummaryNode
 * @classdesc A class representing a speech-to-text session.
 */
(class SvSpeechToTextSession extends SvSummaryNode {
    /**
   * @description Initializes the prototype slots for the SvSpeechToTextSession class.
   */
    initPrototypeSlots () {
    /**
    ...
    /**
   * @description Initializes the SvSpeechToTextSession.
   */
    init () {
        super.init();
    ...
    /**
   * @description Performs final initialization of the SvSpeechToTextSession.
   */
    finalInit () {
        super.finalInit();
   ...
   * @returns {SvSpeechToTextSession} The current instance.
   */
    setupIfNeeded () {
        if (!this.recognition()) {
