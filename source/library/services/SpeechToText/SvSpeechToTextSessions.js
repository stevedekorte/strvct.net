...
/**
 * @class SvSpeechToTextSessions
 * @extends SvSummaryNode
 * @classdesc Manages sessions for speech-to-text conversion.
 */
(class SvSpeechToTextSessions extends SvSummaryNode {

    /**
   * @description Initializes the prototype slots for the SvSpeechToTextSessions class.
   * @private
   ...
   */
     ...
     */
        this.setSubnodeClasses([SvSpeechToTextSession]);
