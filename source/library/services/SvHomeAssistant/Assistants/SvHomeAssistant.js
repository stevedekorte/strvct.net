...
/**
 * @module library.services.SvHomeAssistant.Assistants
 */

/**
 * @class SvHomeAssistant
 * @extends SvSummaryNode
 * @classdesc Represents a Home Assistant connection and manages various Home Assistant related nodes.
 */
(class SvHomeAssistant extends SvSummaryNode {
    /**
   * Initialize the prototype slots for the SvHomeAssistant class.
   ...
   */
     ...
     */
        ...
        /**
     * @member {string} host - The host for the SvHomeAssistant websocket server.
     */
        {
            const slot = this.newSlot("host", "localnode.ddns.net");
            slot.setInspectorPath("Settings");
            slot.setLabel("Host (SvHomeAssistant websocket server)");
            slot.setShouldStoreSlot(true);
            slot.setSyncsToView(true);
            slot.setDuplicateOp("duplicate");
            slot.setSlotType("String");
        ...
        /**
     * @member {number} port - The port number for the SvHomeAssistant websocket server.
     */
        {
        ...
        /**
     * @member {string} url - The full URL for the SvHomeAssistant websocket server.
     */
        {
     ...
     */
        ...
        /**
     * @member {SvHomeAssistantFolder|null} rootFolder - The root folder for SvHomeAssistant.
     */
        {
            const slot = this.newSlot("rootFolder", null);
            slot.setFinalInitProto(SvHomeAssistantFolder);
            slot.setShouldStoreSlot(false);
        ...
        /**
     * @member {SvHomeAssistantAreas|null} areasNode - Node for SvHomeAssistant areas.
     */
        {
            const slot = this.newSlot("areasNode", null);
            slot.setFinalInitProto(SvHomeAssistantAreas);
            slot.setShouldStoreSlot(false);
            slot.setIsSubnode(showNodes);
        }

        /**
     * @member {SvHomeAssistantDevices|null} devicesNode - Node for SvHomeAssistant devices.
     */
        {
            const slot = this.newSlot("devicesNode", null);
            slot.setFinalInitProto(SvHomeAssistantDevices);
            slot.setShouldStoreSlot(false);
            slot.setIsSubnode(showNodes);
        }

        /**
     * @member {SvHomeAssistantEntities|null} entitiesNode - Node for SvHomeAssistant entities.
     */
        {
            const slot = this.newSlot("entitiesNode", null);
            slot.setFinalInitProto(SvHomeAssistantEntities);
            slot.setShouldStoreSlot(false);
            slot.setIsSubnode(showNodes);
        }

        /**
     * @member {SvHomeAssistantStates|null} statesNode - Node for SvHomeAssistant states.
     */
        {
            const slot = this.newSlot("statesNode", null);
            slot.setFinalInitProto(SvHomeAssistantStates);
            slot.setShouldStoreSlot(false);
            slot.setIsSubnode(showNodes);
        }
    ...
    /**
   * Initialize the SvHomeAssistant instance.
   ...
   */
    ...
    /**
   * Get the subtitle for the SvHomeAssistant instance.
   ...
   */
    ...
    /**
   * Disconnect from the SvHomeAssistant server.
   ...
   */
    ...
    /**
   * Connect to the SvHomeAssistant server.
   ...
   */
    ...
    /**
   * Check if connected to the SvHomeAssistant server.
   ...
   */
    ...
    /**
   * Get authentication from the SvHomeAssistant server.
   ...
   */
    ...
    /**
   * Send a message to the SvHomeAssistant server.
   ...
   */
    asyncSendMessageDict (dict) {
        ...
        promise.setLabel("SvHomeAssistant request: " + s);
   ...
   */
    ...
    /**
   * @async
   * @description Handle incoming messages from the SvHomeAssistant server.
   ...
   */
    finsihScan () {
      ...
      this.devices().forEach(device => {
          ...
          const node = SvHomeAssistantDevice.clone();
          ...
          deviceEntities.forEach(deviceEntity => {
            const sn = SvHomeAssistantEntity.clone();
