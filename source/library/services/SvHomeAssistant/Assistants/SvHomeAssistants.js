...
/**
 * @class SvHomeAssistants
 * @extends SvSummaryNode
 * @classdesc Represents a collection of home assistants for home automation.
 */
(class SvHomeAssistants extends SvSummaryNode {

    /**
   * @description Initializes the prototype slots for the SvHomeAssistants class.
   ...
   */
     ...
     * @category Structure
     */
        this.setSubnodeClasses([SvHomeAssistant]);
