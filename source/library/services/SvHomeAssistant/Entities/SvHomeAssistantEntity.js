...
/**
 * @class SvHomeAssistantEntity
 * @extends SvHomeAssistantObject
 ...
 * }
 */
(class SvHomeAssistantEntity extends SvHomeAssistantObject {
    /**
   * @description Initializes prototype slots for the SvHomeAssistantEntity.
   ...
   */
    ...
    */
    ...
    /**
   * @description Initializes the SvHomeAssistantEntity.
   * @category Initialization
   */
    init () {
        super.init();
    ...
    /**
   * @description Performs final initialization steps for the SvHomeAssistantEntity.
   * @category Initialization
   */
    finalInit () {
        super.finalInit();
   ...
   * @category Updates
   * @returns {SvHomeAssistantEntity} The current instance.
   */
    updateName () {
        const json = this.haJson();
