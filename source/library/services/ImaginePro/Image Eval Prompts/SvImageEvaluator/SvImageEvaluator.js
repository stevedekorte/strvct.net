...
(class SvImageEvaluator extends SvSummaryNode {
   ...
   * @returns {Promise<SvImageEvaluator>} Returns this for chaining.
   * @category Actions
   */
   ...
   */
    ...
    async asyncComposeBodyJson () {
        ...
        // SvGeminiService will convert this to Gemini's native format
        const messages = [
            {
                role: "system",
