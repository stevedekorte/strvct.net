...
/**
 * @class SvImageEvalChecklistMaker
...
(class SvImageEvalChecklistMaker extends SvSummaryNode {
...
Please create a detailed checklist of elements that should be present in an image generated from this prompt.`;
     ...
     * @returns {Promise<SvImageEvalChecklistMaker>} Returns this for chaining.
     * @category Actions
     */
    ...
    async asyncPerformGeneration () {
        ...
        assert(request.isKindOf(SvGeminiRequest), "request is not a kind of SvGeminiRequest");
