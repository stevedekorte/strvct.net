...
*/
     ...
     */
        ...
        /**
     * @member {SvImagineProImageGenerations} generations
     * @description The generations for tracking task status.
     * @category Output
     */
        {
            const slot = this.newSlot("generations", null);
            slot.setFinalInitProto(SvImagineProImageGenerations);
            slot.setShouldStoreSlot(true);
            slot.setIsSubnode(true);
            slot.setSlotType("SvImagineProImageGenerations");
        }
   ...
   * @returns {SvImagineProImagePrompt} The current instance.
   * @category Lifecycle
   */
