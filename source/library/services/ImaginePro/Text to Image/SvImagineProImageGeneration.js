...
/**
 * @class SvImagineProImageGeneration
 * @extends SvSummaryNode
 * @classdesc Represents an ImaginePro image generation task that polls for completion.
 */
"use strict";

(class SvImagineProImageGeneration extends SvSummaryNode {
   ...
   */
    service () {
        return SvImagineProService.shared();
    }
   ...
   */
    async pollTaskStatus () {
        try {
            ...
            const endpoint = SvImagineProImagePrompt.endpointBase() + "api/v1/message/fetch/" + this.taskId();
            //const endpoint = SvImagineProImagePrompt.endpointBase() + "api/v1/midjourney/message/" + this.taskId();
   ...
   * @returns {SvImagineProImageGeneration} The current instance.
   * @category Lifecycle
   */
    shutdown () {
        this.stopPolling();
