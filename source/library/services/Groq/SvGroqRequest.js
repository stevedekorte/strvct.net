...
/**
    ...
    * @classdesc
    * SvGroqRequest class for handling API requests to Groq.
    *
    * Example request:
    *
    ...
    */
(class SvGroqRequest extends SvOpenAiRequest {

    /**
            * @description Initializes prototype slots for the SvGroqRequest class.
    ...
    /**
            * @description Initializes the SvGroqRequest instance.
            * @category Initialization
            */
    init () {
        super.init();
    ...
    /**
            ...
            */
    apiKey () {
        return SvGroqService.shared().apiKeyOrUserAuthToken();
    }

    /**
            * @description Sets up the request for streaming.
            * @returns {SvGroqRequest} The current SvGroqRequest instance.
