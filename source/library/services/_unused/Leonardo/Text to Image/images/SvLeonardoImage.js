...
/**
 * @class SvLeonardoImage
 * @extends SvSummaryNode
 * @classdesc Represents an image generated by Leonardo's text-to-image service.
 */
(class SvLeonardoImage extends SvSummaryNode {
    /**
   * @description Initializes the prototype slots for the SvLeonardoImage class.
   */
    initPrototypeSlots () {
     ...
     */
        ...
        /**
     * @member {string} prompt - The text prompt used for image generation.
     * @category Prompt
     */
        {
  ...
  */
        ...
        //const apiKey = SvLeonardoService.shared().apiKeyOrUserAuthToken();
        const url = this.url();
   ...
   * @returns {SvOpenAiImage} The current instance.
   * @category Lifecycle
   */
    shutdown () {
    /*
